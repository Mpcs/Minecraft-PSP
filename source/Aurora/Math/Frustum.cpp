...
namespace Aurora {
    namespace Math {
        ...
        Frustum::PlaneIntersectionType
        Frustum::BoxInFrustum(float minx, float miny, float minz, float maxx, float maxy, float maxz) {
        ...
        void
        Frustum::Clip(int plane, int vertexCount, TexturesPSPVertex *in, int i, TexturesPSPVertex *out, int &outCount) {
            //for each vertex
            outCount = 0;
