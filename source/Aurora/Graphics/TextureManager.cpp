...
namespace Aurora {
    namespace Graphics {
        ...
        void TextureManager::setColour(int x, int y, unsigned char red, unsigned char green, unsigned char blue,
                                       unsigned char alpha, int number) {
            Image *testImage = Images[number];
        ...
        Image *TextureManager::LoadPng(const char *filename, int ColorMode, int Swizzle, int Vram) {
            ...
            png_get_IHDR(png_ptr, info_ptr, &width, &height, &bit_depth, &color_type, &interlace_type, int_p_NULL,
                         int_p_NULL);
            ...
            if (Vram == 1) {
                ...
                Image1->ImageData = (unsigned short *) malloc(
                        Image1->power2Height * Image1->power2Width * OutBytesPerPixel);
            }
            swizzle_fast((u8 *) Image1->ImageData, (const u8 *) Buffer, Image1->power2Width * OutBytesPerPixel,
                         Image1->power2Height);
