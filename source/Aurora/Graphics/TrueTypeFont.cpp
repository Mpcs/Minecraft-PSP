...
#undef CASE
        ...
        void
        TrueTypeFont::getBakedQuad(stbtt_bakedchar2 *chardata, int pw, int ph, int char_index, float *xpos, float *ypos,
        ...
        void TrueTypeFont::DrawText(float x, float y, const char *text, int align, unsigned int col) {
            ...
            TexturedVertex *vertices = (TexturedVertex *) RenderManager::Instance()->CreateVertexObject(Textured,
                                                                                                        vertsCount);
            int ver = 0;
