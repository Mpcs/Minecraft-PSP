    ...
    switch (menuState) {
        ...
        case 3://about
        {
            ...
            if (mRender->GetFontLanguage() == ENGLISH) {
                ...
                aboutPos == 0 ? DrawText(240, 234, GU_COLOR(1, 1, 0.25, 1), default_size, "Converter") : DrawText(240,
                                                                                                                  234,
                                                                                                                  GU_COLOR(
                                                                                                                          1,
                                                                                                                          1,
                                                                                                                  ...
                                                                                                                  default_size,
                                                                                                                  "Converter");
                aboutPos == 1 ? DrawText(240, 264, GU_COLOR(1, 1, 0.25, 1), default_size, "Cancel") : DrawText(240, 264,
                                                                                                               GU_COLOR(
                                                                                                                       1,
                                                                                                                       1,
                                                                                                                       1,
            ...
            if (mRender->GetFontLanguage() == RUSSIAN) {
                ...
                aboutPos == 0 ? DrawText(240, 234, GU_COLOR(1, 1, 0.25, 1), default_size, "Konverter") : DrawText(240,
                                                                                                                  234,
                                                                                                                  GU_COLOR(
                                                                                                                          1,
                                                                                                                          1,
                                                                                                                  ...
                                                                                                                  default_size,
                                                                                                                  "Konverter");
                aboutPos == 1 ? DrawText(240, 264, GU_COLOR(1, 1, 0.25, 1), default_size, "Otmena") : DrawText(240, 264,
                                                                                                               GU_COLOR(
                                                                                                                       1,
                                                                                                                       1,
                                                                                                                       1,
