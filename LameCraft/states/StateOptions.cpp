...
void StateOptions::Draw(StateManager *sManager) {
    ...
    switch (menuState) {
        ...
        case 1://controls
        {
            ...
            if (mRender->GetFontLanguage() == ENGLISH) {
                controlPos == 16 ? DrawText(240, 269, GU_COLOR(1, 1, 0, 1), default_size, "Cancel") : DrawText(240, 269,
                                                                                                               GU_COLOR(
                                                                                                                       1,
                                                                                                                       1,
                                                                                                                       1,
            ...
            if (mRender->GetFontLanguage() == RUSSIAN) {
                controlPos == 16 ? DrawText(240, 269, GU_COLOR(1, 1, 0, 1), default_size, "Otmena") : DrawText(240, 269,
                                                                                                               GU_COLOR(
                                                                                                                       1,
                                                                                                                       1,
                                                                                                                       1,
        ...
        case 2://analog stick
        {
            ...
            if (mRender->GetFontLanguage() == ENGLISH) {
                currentAnalogPos == 0 ? mRender->SetFontStyle(default_size, GU_COLOR(1, 1, 0.25f, 1), 0, 0x00000200)
                                      : mRender->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0, 0x00000200);
                mRender->DebugPrint(240, 109, "Analog up : %d%%",
                                    (int) (fabs(InputHelper::Instance()->analogYup) * 100.0f));

                currentAnalogPos == 1 ? mRender->SetFontStyle(default_size, GU_COLOR(1, 1, 0.25f, 1), 0, 0x00000200)
                                      : mRender->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0, 0x00000200);
                mRender->DebugPrint(240, 139, "Analog down : %d%%",
                                    (int) (fabs(InputHelper::Instance()->analogYdown) * 100.0f));

                currentAnalogPos == 2 ? mRender->SetFontStyle(default_size, GU_COLOR(1, 1, 0.25f, 1), 0, 0x00000200)
                                      : mRender->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0, 0x00000200);
                mRender->DebugPrint(240, 169, "Analog left : %d%%",
                                    (int) (fabs(InputHelper::Instance()->analogXleft) * 100.0f));

                currentAnalogPos == 3 ? mRender->SetFontStyle(default_size, GU_COLOR(1, 1, 0.25f, 1), 0, 0x00000200)
                                      : mRender->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0, 0x00000200);
                mRender->DebugPrint(240, 199, "Analog right : %d%%",
                                    (int) (fabs(InputHelper::Instance()->analogXright) * 100.0f));

                currentAnalogPos >= 4 ? mRender->SetFontStyle(default_size, GU_COLOR(1, 1, 0.25f, 1), 0, 0x00000200)
                                      : mRender->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0, 0x00000200);
            ...
            if (mRender->GetFontLanguage() == RUSSIAN) {
                currentAnalogPos == 0 ? mRender->SetFontStyle(default_size, GU_COLOR(1, 1, 0.25f, 1), 0, 0x00000200)
                                      : mRender->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0, 0x00000200);
                mRender->DebugPrint(240, 109, "Stik vverh : %d%%",
                                    (int) (fabs(InputHelper::Instance()->analogYup) * 100.0f));

                currentAnalogPos == 1 ? mRender->SetFontStyle(default_size, GU_COLOR(1, 1, 0.25f, 1), 0, 0x00000200)
                                      : mRender->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0, 0x00000200);
                mRender->DebugPrint(240, 139, "Stik vniz : %d%%",
                                    (int) (fabs(InputHelper::Instance()->analogYdown) * 100.0f));

                currentAnalogPos == 2 ? mRender->SetFontStyle(default_size, GU_COLOR(1, 1, 0.25f, 1), 0, 0x00000200)
                                      : mRender->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0, 0x00000200);
                mRender->DebugPrint(240, 169, "Stik vlevo : %d%%",
                                    (int) (fabs(InputHelper::Instance()->analogXleft) * 100.0f));

                currentAnalogPos == 3 ? mRender->SetFontStyle(default_size, GU_COLOR(1, 1, 0.25f, 1), 0, 0x00000200)
                                      : mRender->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0, 0x00000200);
                mRender->DebugPrint(240, 199, "Stik vpravo : %d%%",
                                    (int) (fabs(InputHelper::Instance()->analogXright) * 100.0f));
