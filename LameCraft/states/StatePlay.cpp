...
void StatePlay::InitCamera() {
    fppCam = new Camera();
    fppCam->PositionCamera(playerPosition.x, playerPosition.y, playerPosition.z, playerPosition.x, playerPosition.y,
                           playerPosition.z - 5.0f, 0.0f, 1.0f, 0.0f);
...
void StatePlay::LoadMap(std::string fileName, bool compressed) {
    ...
    mWorld->playerZoneSize = Vector3(CHUNK_SIZE * mWorld->mainOptions.horizontalViewDistance,
                                     CHUNK_SIZE * mWorld->mainOptions.verticalViewDistance,
                                     CHUNK_SIZE * mWorld->mainOptions.horizontalViewDistance);
...
void StatePlay::LoadTextures() {
    ...
    barSprite = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils), 0 * utilsSize / 182,
                           0 * utilsSize / 182, 182 * utilsSize / 182, 22 * utilsSize / 182);
    barSprite->SetPosition(240, 250);
    barSprite->Scale(utilScale, utilScale);

    selectSprite = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils), 0 * utilsSize / 182,
                              22 * utilsSize / 182, 24 * utilsSize / 182, 24 * utilsSize / 182);
    selectSprite->SetPosition(80, 250);
    selectSprite->Scale(utilScale, utilScale);

    crossSprite = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils), 24 * utilsSize / 182,
                             22 * utilsSize / 182, 9 * utilsSize / 182, 9 * utilsSize / 182);
    crossSprite->SetPosition(240, 136);
    crossSprite->Scale(utilScale, utilScale);

    hpCellSpriteW = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils), 60 * utilsSize / 182,
                               36 * utilsSize / 182, 82 * utilsSize / 182, 10 * utilsSize / 182);
    hpCellSpriteW->SetPosition(100, 29);
    hpCellSpriteW->Scale(utilScale, utilScale);

    hpCellSprite = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils), 60 * utilsSize / 182,
                              46 * utilsSize / 182, 82 * utilsSize / 182, 10 * utilsSize / 182);
    hpCellSprite->SetPosition(100, 21);
    hpCellSprite->Scale(utilScale, utilScale);

    hgCellSprite = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils), 60 * utilsSize / 182,
                              56 * utilsSize / 182, 82 * utilsSize / 182, 10 * utilsSize / 182);
    hgCellSprite->SetPosition(100, 24);
    hgCellSprite->Scale(utilScale, utilScale);

    arCellSprite = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils), 60 * utilsSize / 182,
                              66 * utilsSize / 182, 82 * utilsSize / 182, 10 * utilsSize / 182);
    arCellSprite->SetPosition(100, 27);
    arCellSprite->Scale(utilScale, utilScale);

    hpSprite = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils), 0 * utilsSize / 182,
                          66 * utilsSize / 182, 10 * utilsSize / 182, 10 * utilsSize / 182);
    hpSprite->SetPosition(100, 22);
    hpSprite->Scale(utilScale, utilScale);

    hpSpriteW = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils), 20 * utilsSize / 182,
                           66 * utilsSize / 182, 10 * utilsSize / 182, 10 * utilsSize / 182);
    hpSpriteW->SetPosition(100, 22);
    hpSpriteW->Scale(utilScale, utilScale);

    hpHardSprite = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils), 0 * utilsSize / 182,
                              56 * utilsSize / 182, 10 * utilsSize / 182, 10 * utilsSize / 182);
    hpHardSprite->SetPosition(100, 22);
    hpHardSprite->Scale(utilScale, utilScale);

    hpHardSpriteW = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils), 20 * utilsSize / 182,
                               56 * utilsSize / 182, 10 * utilsSize / 182, 10 * utilsSize / 182);
    hpHardSpriteW->SetPosition(100, 22);
    hpHardSpriteW->Scale(utilScale, utilScale);

    hpHalfSprite = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils), 10 * utilsSize / 182,
                              66 * utilsSize / 182, 10 * utilsSize / 182, 10 * utilsSize / 182);
    hpHalfSprite->SetPosition(100, 22);
    hpHalfSprite->Scale(utilScale, utilScale);

    hpHalfSpriteW = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils), 30 * utilsSize / 182,
                               66 * utilsSize / 182, 10 * utilsSize / 182, 10 * utilsSize / 182);
    hpHalfSpriteW->SetPosition(100, 22);
    hpHalfSpriteW->Scale(utilScale, utilScale);

    hpHardHalfSprite = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils), 10 * utilsSize / 182,
                                  56 * utilsSize / 182, 10 * utilsSize / 182, 10 * utilsSize / 182);
    hpHardHalfSprite->SetPosition(100, 22);
    hpHardHalfSprite->Scale(utilScale, utilScale);

    hpHardHalfSpriteW = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils), 30 * utilsSize / 182,
                                   56 * utilsSize / 182, 10 * utilsSize / 182, 10 * utilsSize / 182);
    hpHardHalfSpriteW->SetPosition(100, 22);
    hpHardHalfSpriteW->Scale(utilScale, utilScale);

    hgSprite = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils), 30 * utilsSize / 182,
                          46 * utilsSize / 182, 10 * utilsSize / 182, 10 * utilsSize / 182);
    hgSprite->SetPosition(100, 26);
    hgSprite->Scale(utilScale, utilScale);

    hgHalfSprite = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils), 40 * utilsSize / 182,
                              46 * utilsSize / 182, 10 * utilsSize / 182, 10 * utilsSize / 182);
    hgHalfSprite->SetPosition(100, 26);
    hgHalfSprite->Scale(utilScale, utilScale);

    bubbleSprite = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils), 0 * utilsSize / 182,
                              46 * utilsSize / 182, 10 * utilsSize / 182, 10 * utilsSize / 182);
    bubbleSprite->SetPosition(100, 27);
    bubbleSprite->Scale(utilScale, utilScale);

    arSprite = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils), 10 * utilsSize / 182,
                          46 * utilsSize / 182, 10 * utilsSize / 182, 10 * utilsSize / 182);
    arSprite->SetPosition(100, 27);
    arSprite->Scale(utilScale, utilScale);

    arHalfSprite = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils), 20 * utilsSize / 182,
                              46 * utilsSize / 182, 10 * utilsSize / 182, 10 * utilsSize / 182);
    arHalfSprite->SetPosition(100, 27);
    arHalfSprite->Scale(utilScale, utilScale);

    for (int j = 13; j >= 0; j--) {
        toolPointSprite[j] = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::Utils),
                                        169 * utilsSize / 182, (49 + (13 - j) * 2) * utilsSize / 182,
                                        13 * utilsSize / 182, 2 * utilsSize / 182, true);//200
    ...
    int invArrowSize = TextureManager::Instance()->getWidth(
            TextureHelper::Instance()->GetTexture(TextureHelper::furArrow));
    float invArrowScale = 44.0f / (float) invArrowSize;

    for (int j = 0; j <= 21; j++) {
        furArrowSprite[j] = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::furArrow), 0, 0,
                                       (1 * j) * invArrowSize / 22.0f, 16 * invArrowSize / 22.0f, true);//200
        furArrowSprite[j]->SetPosition(240, 136);
        furArrowSprite[j]->Scale(invArrowScale, invArrowScale);
    }

    int invFireSize = TextureManager::Instance()->getWidth(
            TextureHelper::Instance()->GetTexture(TextureHelper::furFire));
    float invFireScale = 28.0f / (float) invFireSize;

    for (int j = 0; j <= 13; j++) {
        furFireSprite[13 - j] = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::furFire), 0,
                                           j * invFireSize / 14.0f, 14 * invFireSize / 14.0f,
                                           (14 - j) * invFireSize / 14.0f, true);//200
...
void StatePlay::CraftItem2x2() {
    ...
    for (int i = 0; i <= 3; i++) {
        ...
        if (craftSlotId[i] >= BlackWoolBlock::getID() && craftSlotId[i] <= WhiteWoolBlock::getID()) {
            materialString += "W";
        } else if (craftSlotId[i] == OakPlanks::getID() || craftSlotId[i] == SprucePlanks::getID() ||
                   craftSlotId[i] == BirchPlanks::getID()) {
            materialString += "P";
        } else {
            materialString += "0";
        }
    ...
    if (enableMainCraftBody) {
        switch (result) {
            ...
            case 213:
                if (craftSlotId[0] == HayBale::getID() || craftSlotId[1] == HayBale::getID() ||
                    craftSlotId[2] == HayBale::getID() || craftSlotId[3] == HayBale::getID()) {
            ...
            case 214:
                if (craftSlotId[0] == CoalBlock::getID() || craftSlotId[1] == CoalBlock::getID() ||
                    craftSlotId[2] == CoalBlock::getID() || craftSlotId[3] == CoalBlock::getID()) {
            ...
            case 215:
                if (craftSlotId[0] == RedstoneBlock::getID() || craftSlotId[1] == RedstoneBlock::getID() ||
                    craftSlotId[2] == RedstoneBlock::getID() || craftSlotId[3] == RedstoneBlock::getID()) {
            ...
            case 12:
                ...
                // half to carved stone brick
            case 216:
                if ((craftSlotId[0] == 108 && craftSlotId[2] == 108) ||
                    (craftSlotId[1] == 108 && craftSlotId[3] == 108)) {
                    craftItemId = 104;
                    craftItemSt = 1;
                    craftItemAm = 1;
                }
            ...
            case 68: // oak
                ...
                break;
            case 310: // birch
                if ((craftSlotId[0] == 155 && craftSlotId[2] == 155) ||
                    (craftSlotId[1] == 155 && craftSlotId[3] == 155)) {
                    craftItemId = 276;
                    craftItemSt = 1;
                    craftItemAm = 4;
                }
                break;
            case 312: // spruce
                if ((craftSlotId[0] == 156 && craftSlotId[2] == 156) ||
                    (craftSlotId[1] == 156 && craftSlotId[3] == 156)) {
                    craftItemId = 276;
                    craftItemSt = 1;
                    craftItemAm = 4;
                }
                ...
                // torch
            case 553:
                if (((craftSlotId[0] == 277 || craftSlotId[0] == 392) && craftSlotId[2] == 276) ||
                    ((craftSlotId[1] == 277 || craftSlotId[1] == 392) && craftSlotId[3] == 276)) {
                    craftItemId = 308;
                    craftItemSt = 1;
                    craftItemAm = 4;
                }
            ...
            case 668:
                ...
                // jack o'lantern
            case 383:
                if ((craftSlotId[0] == Pumpkin3::getID() && craftSlotId[2] == TorchItem::getID()) ||
                    (craftSlotId[1] == Pumpkin3::getID() && craftSlotId[3] == TorchItem::getID())) {
                    craftItemId = JackOLantern3::getID();
                    craftItemSt = 1;
                    craftItemAm = 1;
                }
            ...
            case 75:
                ...
                // rose to dye
            case 294:
                if (craftSlotId[0] == Flower1Item::getID() || craftSlotId[1] == Flower1Item::getID() ||
                    craftSlotId[2] == Flower1Item::getID() || craftSlotId[3] == Flower1Item::getID()) {
                ...
                // dandelion to dye
            case 295:
                if (craftSlotId[0] == Flower2Item::getID() || craftSlotId[1] == Flower2Item::getID() ||
                    craftSlotId[2] == Flower2Item::getID() || craftSlotId[3] == Flower2Item::getID()) {
...
void StatePlay::CraftItem3x3() {
    ...
    for (int i = 0; i <= 8; i++) {
        ...
        if (craftSlotId3[i] >= BlackWoolBlock::getID() && craftSlotId3[i] <= WhiteWoolBlock::getID()) {
            materialString += "W";
        } else if (craftSlotId3[i] == OakPlanks::getID() || craftSlotId3[i] == SprucePlanks::getID() ||
                   craftSlotId3[i] == BirchPlanks::getID()) {
            materialString += "P";
        } else {
            materialString += "0";
        }
        ...
        switch (result) {
            case 321://bone to bone meals
                if (craftSlotId3[0] == 321 || craftSlotId3[1] == 321 || craftSlotId3[2] == 321 ||
                    ...
                    craftSlotId3[6] == 321 || craftSlotId3[7] == 321 || craftSlotId3[8] == 321) {
                    craftItemId3 = 322;
                    craftItemSt3 = 1;
                    craftItemAm3 = 3;
                }
            ...
            case 294: //rose to dye
                if (craftSlotId3[0] == Flower1Item::getID() || craftSlotId3[1] == Flower1Item::getID() ||
                    craftSlotId3[2] == Flower1Item::getID() ||
                    craftSlotId3[3] == Flower1Item::getID() || craftSlotId3[4] == Flower1Item::getID() ||
                    craftSlotId3[5] == Flower1Item::getID() ||
                    craftSlotId3[6] == Flower1Item::getID() || craftSlotId3[7] == Flower1Item::getID() ||
                    craftSlotId3[8] == Flower1Item::getID()) {
            ...
            case 295: //rose to dye
                if (craftSlotId3[0] == Flower2Item::getID() || craftSlotId3[1] == Flower2Item::getID() ||
                    craftSlotId3[2] == Flower2Item::getID() ||
                    craftSlotId3[3] == Flower2Item::getID() || craftSlotId3[4] == Flower2Item::getID() ||
                    craftSlotId3[5] == Flower2Item::getID() ||
                    craftSlotId3[6] == Flower2Item::getID() || craftSlotId3[7] == Flower2Item::getID() ||
                    craftSlotId3[8] == Flower2Item::getID()) {
            ...
            case 625: //noteblock (oak)
                if (craftSlotId3[1] == 34 && craftSlotId3[2] == 34 && craftSlotId3[3] == 34 && craftSlotId3[5] == 34 &&
                    craftSlotId3[7] == 34 && craftSlotId3[0] == 34 && craftSlotId3[6] == 34 && craftSlotId3[8] == 34 &&
                    craftSlotId3[4] == Redstone::getID()) {
            ...
            case 1593: //noteblock (birch)
                if (craftSlotId3[1] == 155 && craftSlotId3[2] == 155 && craftSlotId3[3] == 155 &&
                    craftSlotId3[5] == 155 && craftSlotId3[7] == 155 && craftSlotId3[0] == 155 &&
                    craftSlotId3[6] == 155 && craftSlotId3[8] == 155 && craftSlotId3[4] == Redstone::getID()) {
                    craftItemId3 = NoteBlock::getID();
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
                }
            ...
            case 1601: //noteblock (spruce)
                if (craftSlotId3[1] == 156 && craftSlotId3[2] == 156 && craftSlotId3[3] == 156 &&
                    craftSlotId3[5] == 156 && craftSlotId3[7] == 156 && craftSlotId3[0] == 156 &&
                    craftSlotId3[6] == 156 && craftSlotId3[8] == 156 && craftSlotId3[4] == Redstone::getID()) {
                    craftItemId3 = NoteBlock::getID();
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
                }
            ...
            case 551: //noteblock (oak)
                if (craftSlotId3[1] == 34 && craftSlotId3[2] == 34 && craftSlotId3[3] == 34 && craftSlotId3[5] == 34 &&
                    craftSlotId3[7] == 34 && craftSlotId3[0] == 34 && craftSlotId3[6] == 34 && craftSlotId3[8] == 34 &&
                    craftSlotId3[4] == DiamondItem::getID()) {
            ...
            case 1519: //noteblock (birch)
                if (craftSlotId3[1] == 155 && craftSlotId3[2] == 155 && craftSlotId3[3] == 155 &&
                    craftSlotId3[5] == 155 && craftSlotId3[7] == 155 && craftSlotId3[0] == 155 &&
                    craftSlotId3[6] == 155 && craftSlotId3[8] == 155 && craftSlotId3[4] == DiamondItem::getID()) {
                    craftItemId3 = JukeBox::getID();
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
                }
            ...
            case 1527: //noteblock (spruce)
                if (craftSlotId3[1] == 156 && craftSlotId3[2] == 156 && craftSlotId3[3] == 156 &&
                    craftSlotId3[5] == 156 && craftSlotId3[7] == 156 && craftSlotId3[0] == 156 &&
                    craftSlotId3[6] == 156 && craftSlotId3[8] == 156 && craftSlotId3[4] == DiamondItem::getID()) {
                    craftItemId3 = JukeBox::getID();
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
                }
            ...
            case 8: //wood to planks
                if (craftSlotId3[0] == 8 || craftSlotId3[1] == 8 || craftSlotId3[2] == 8 || craftSlotId3[3] == 8 ||
                    craftSlotId3[4] == 8 || craftSlotId3[5] == 8 || craftSlotId3[6] == 8 || craftSlotId3[7] == 8 ||
                    craftSlotId3[8] == 8) {
                    craftItemId3 = 34;
                    craftItemSt3 = 1;
                    craftItemAm3 = 4;
            ...
            case 31://wood to birch planks
                if (craftSlotId3[0] == 31 || craftSlotId3[1] == 31 || craftSlotId3[2] == 31 || craftSlotId3[3] == 31 ||
                    craftSlotId3[4] == 31 || craftSlotId3[5] == 31 || craftSlotId3[6] == 31 || craftSlotId3[7] == 31 ||
                    craftSlotId3[8] == 31) {
                    craftItemId3 = 155;
                    craftItemSt3 = 1;
                    craftItemAm3 = 4;
            ...
            case 30://wood to spurce planks
                if (craftSlotId3[0] == 30 || craftSlotId3[1] == 30 || craftSlotId3[2] == 30 || craftSlotId3[3] == 30 ||
                    craftSlotId3[4] == 30 || craftSlotId3[5] == 30 || craftSlotId3[6] == 30 || craftSlotId3[7] == 30 ||
                    craftSlotId3[8] == 30) {
                    craftItemId3 = 156;
                    craftItemSt3 = 1;
                    craftItemAm3 = 4;
            ...
            case 311://melon to seeds
                if (craftSlotId3[0] == 311 || craftSlotId3[1] == 311 || craftSlotId3[2] == 311 ||
                    craftSlotId3[3] == 311 || craftSlotId3[4] == 311 || craftSlotId3[5] == 311 ||
                    craftSlotId3[6] == 311 || craftSlotId3[7] == 311 || craftSlotId3[8] == 311) {
                    craftItemId3 = 312;
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
                }
            ...
            case 293://cane to sugar
                if (craftSlotId3[0] == 293 || craftSlotId3[1] == 293 || craftSlotId3[2] == 293 ||
                    craftSlotId3[3] == 293 || craftSlotId3[4] == 293 || craftSlotId3[5] == 293 ||
                    craftSlotId3[6] == 293 || craftSlotId3[7] == 293 || craftSlotId3[8] == 293) {
                    craftItemId3 = 313;
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
                }
            ...
            case 68://sticks
                if ((craftSlotId3[0] == 34 && craftSlotId3[3] == 34) ||
                    (craftSlotId3[1] == 34 && craftSlotId3[4] == 34) ||
                    (craftSlotId3[2] == 34 && craftSlotId3[5] == 34) ||
                    (craftSlotId3[3] == 34 && craftSlotId3[6] == 34) ||
                    (craftSlotId3[4] == 34 && craftSlotId3[7] == 34) ||
                    (craftSlotId3[5] == 34 && craftSlotId3[8] == 34)) {
                    craftItemId3 = 276;
                    craftItemSt3 = 1;
                    craftItemAm3 = 4;
                }
                break;
            case 310: //birch
                if ((craftSlotId3[0] == 155 && craftSlotId3[3] == 155) ||
                    (craftSlotId3[1] == 155 && craftSlotId3[4] == 155) ||
                    (craftSlotId3[2] == 155 && craftSlotId3[5] == 155) ||
                    (craftSlotId3[3] == 155 && craftSlotId3[6] == 155) ||
                    (craftSlotId3[4] == 155 && craftSlotId3[7] == 155) ||
                    (craftSlotId3[5] == 155 && craftSlotId3[8] == 155)) {
                    craftItemId3 = 276;
                    craftItemSt3 = 1;
                    craftItemAm3 = 4;
                }
                break;
            case 312://spruce
                if ((craftSlotId3[0] == 156 && craftSlotId3[3] == 156) ||
                    (craftSlotId3[1] == 156 && craftSlotId3[4] == 156) ||
                    (craftSlotId3[2] == 156 && craftSlotId3[5] == 156) ||
                    (craftSlotId3[3] == 156 && craftSlotId3[6] == 156) ||
                    (craftSlotId3[4] == 156 && craftSlotId3[7] == 156) ||
                    (craftSlotId3[5] == 156 && craftSlotId3[8] == 156)) {
                    craftItemId3 = 276;
                    craftItemSt3 = 1;
                    craftItemAm3 = 4;
                }
            ...
            case 688: // oak fence
                if ((craftSlotId3[0] == 34 && craftSlotId3[1] == 276 && craftSlotId3[2] == 34 &&
                     craftSlotId3[3] == 34 && craftSlotId3[4] == 276 && craftSlotId3[5] == 34) ||
                    (craftSlotId3[3] == 34 && craftSlotId3[4] == 276 && craftSlotId3[5] == 34 &&
                     craftSlotId3[6] == 34 && craftSlotId3[7] == 276 && craftSlotId3[8] == 34)) {
            ...
            case 1172: // birch fence
                if ((craftSlotId3[0] == 155 && craftSlotId3[1] == 276 && craftSlotId3[2] == 155 &&
                     craftSlotId3[3] == 155 && craftSlotId3[4] == 276 && craftSlotId3[5] == 155) ||
                    (craftSlotId3[3] == 155 && craftSlotId3[4] == 276 && craftSlotId3[5] == 155 &&
                     craftSlotId3[6] == 155 && craftSlotId3[7] == 276 && craftSlotId3[8] == 155)) {
            ...
            case 1176: // spruce fence
                if ((craftSlotId3[0] == 156 && craftSlotId3[1] == 276 && craftSlotId3[2] == 156 &&
                     craftSlotId3[3] == 156 && craftSlotId3[4] == 276 && craftSlotId3[5] == 156) ||
                    (craftSlotId3[3] == 156 && craftSlotId3[4] == 276 && craftSlotId3[5] == 156 &&
                     craftSlotId3[6] == 156 && craftSlotId3[7] == 276 && craftSlotId3[8] == 156)) {
            ...
            case 240: //glass panel
                if ((craftSlotId3[0] == 40 && craftSlotId3[1] == 40 && craftSlotId3[2] == 40 && craftSlotId3[3] == 40 &&
                     craftSlotId3[4] == 40 && craftSlotId3[5] == 40)
                    ||
                    (craftSlotId3[3] == 40 && craftSlotId3[4] == 40 && craftSlotId3[5] == 40 && craftSlotId3[6] == 40 &&
                     craftSlotId3[7] == 40 && craftSlotId3[8] == 40)) {
            ...
            case 1668: //iron bars
                if ((craftSlotId3[0] == 278 && craftSlotId3[1] == 278 && craftSlotId3[2] == 278 &&
                     craftSlotId3[3] == 278 && craftSlotId3[4] == 278 && craftSlotId3[5] == 278)
                    || (craftSlotId3[3] == 278 && craftSlotId3[4] == 278 && craftSlotId3[5] == 278 &&
                        craftSlotId3[6] == 278 && craftSlotId3[7] == 278 && craftSlotId3[8] == 278)) {
            ...
            case 204: //door
                if ((craftSlotId3[0] == 34 && craftSlotId3[1] == 34 && craftSlotId3[3] == 34 && craftSlotId3[4] == 34 &&
                     craftSlotId3[6] == 34 && craftSlotId3[7] == 34) ||
                    (craftSlotId3[1] == 34 && craftSlotId3[2] == 34 && craftSlotId3[4] == 34 && craftSlotId3[5] == 34 &&
                     craftSlotId3[7] == 34 && craftSlotId3[8] == 34)) {
                    craftItemId3 = 306;
                    craftItemSt3 = 0;
                    craftItemAm3 = 1;
                }
                //wooden stair
                if ((craftSlotId3[0] == 34 && craftSlotId3[3] == 34 && craftSlotId3[4] == 34 && craftSlotId3[6] == 34 &&
                     craftSlotId3[7] == 34 && craftSlotId3[8] == 34) ||
                    (craftSlotId3[2] == 34 && craftSlotId3[4] == 34 && craftSlotId3[5] == 34 && craftSlotId3[6] == 34 &&
                     craftSlotId3[7] == 34 && craftSlotId3[8] == 34)) {
                    craftItemId3 = 125;
                    craftItemSt3 = 1;
                    craftItemAm3 = 4;
                ...
                //trapdoor
                if ((craftSlotId3[0] == 34 && craftSlotId3[1] == 34 && craftSlotId3[2] == 34 && craftSlotId3[3] == 34 &&
                     craftSlotId3[4] == 34 && craftSlotId3[5] == 34) ||
                    (craftSlotId3[3] == 34 && craftSlotId3[4] == 34 && craftSlotId3[5] == 34 && craftSlotId3[6] == 34 &&
                     craftSlotId3[7] == 34 && craftSlotId3[8] == 34)) {
            ...
            case 930: //door (birch)
                if ((craftSlotId3[0] == 155 && craftSlotId3[1] == 155 && craftSlotId3[3] == 155 &&
                     craftSlotId3[4] == 155 && craftSlotId3[6] == 155 && craftSlotId3[7] == 155) ||
                    (craftSlotId3[1] == 155 && craftSlotId3[2] == 155 && craftSlotId3[4] == 155 &&
                     craftSlotId3[5] == 155 && craftSlotId3[7] == 155 && craftSlotId3[8] == 155)) {
                    craftItemId3 = 306;
                    craftItemSt3 = 0;
                    craftItemAm3 = 1;
                }
                //wooden stair
                if ((craftSlotId3[0] == 155 && craftSlotId3[3] == 155 && craftSlotId3[4] == 155 &&
                     craftSlotId3[6] == 155 && craftSlotId3[7] == 155 && craftSlotId3[8] == 155) ||
                    (craftSlotId3[2] == 155 && craftSlotId3[4] == 155 && craftSlotId3[5] == 155 &&
                     craftSlotId3[6] == 155 && craftSlotId3[7] == 155 && craftSlotId3[8] == 155)) {
            ...
            case 936: //door (spruce)
                if ((craftSlotId3[0] == 156 && craftSlotId3[1] == 156 && craftSlotId3[3] == 156 &&
                     craftSlotId3[4] == 156 && craftSlotId3[6] == 156 && craftSlotId3[7] == 156) ||
                    (craftSlotId3[1] == 156 && craftSlotId3[2] == 156 && craftSlotId3[4] == 156 &&
                     craftSlotId3[5] == 156 && craftSlotId3[7] == 156 && craftSlotId3[8] == 156)) {
                    craftItemId3 = 306;
                    craftItemSt3 = 0;
                    craftItemAm3 = 1;
                }
                //wooden stair
                if ((craftSlotId3[0] == 156 && craftSlotId3[3] == 156 && craftSlotId3[4] == 156 &&
                     craftSlotId3[6] == 156 && craftSlotId3[7] == 156 && craftSlotId3[8] == 156) ||
                    (craftSlotId3[2] == 156 && craftSlotId3[4] == 156 && craftSlotId3[5] == 156 &&
                     craftSlotId3[6] == 156 && craftSlotId3[7] == 156 && craftSlotId3[8] == 156)) {
            ...
            case 216://stone stair
                if ((craftSlotId3[0] == 36 && craftSlotId3[3] == 36 && craftSlotId3[4] == 36 && craftSlotId3[6] == 36 &&
                     craftSlotId3[7] == 36 && craftSlotId3[8] == 36) ||
                    (craftSlotId3[2] == 36 && craftSlotId3[4] == 36 && craftSlotId3[5] == 36 && craftSlotId3[6] == 36 &&
                     craftSlotId3[7] == 36 && craftSlotId3[8] == 36)) {
                    craftItemId3 = 60;
                    craftItemSt3 = 1;
                    craftItemAm3 = 4;
                ...
                if ((craftSlotId3[0] == 108 && craftSlotId3[3] == 108) ||
                    (craftSlotId3[1] == 108 && craftSlotId3[4] == 108) ||
                    (craftSlotId3[2] == 108 && craftSlotId3[5] == 108) ||
                    (craftSlotId3[3] == 108 && craftSlotId3[6] == 108) ||
                    (craftSlotId3[4] == 108 && craftSlotId3[7] == 108) ||
                    (craftSlotId3[5] == 108 && craftSlotId3[8] == 108)) {
                    craftItemId3 = 104;
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
                }
            ...
            case 162://brick stair
                if ((craftSlotId3[0] == 27 && craftSlotId3[3] == 27 && craftSlotId3[4] == 27 && craftSlotId3[6] == 27 &&
                     craftSlotId3[7] == 27 && craftSlotId3[8] == 27) ||
                    (craftSlotId3[2] == 27 && craftSlotId3[4] == 27 && craftSlotId3[5] == 27 && craftSlotId3[6] == 27 &&
                     craftSlotId3[7] == 27 && craftSlotId3[8] == 27)) {
                    craftItemId3 = 67;
                    craftItemSt3 = 1;
                    craftItemAm3 = 4;
            ...
            case 136://crafting
                if ((craftSlotId3[0] == 34 && craftSlotId3[1] == 34 && craftSlotId3[3] == 34 &&
                     craftSlotId3[4] == 34) ||
                    (craftSlotId3[1] == 34 && craftSlotId3[2] == 34 && craftSlotId3[4] == 34 &&
                     craftSlotId3[5] == 34) ||
                    (craftSlotId3[3] == 34 && craftSlotId3[4] == 34 && craftSlotId3[6] == 34 &&
                     craftSlotId3[7] == 34) ||
                    (craftSlotId3[4] == 34 && craftSlotId3[5] == 34 && craftSlotId3[7] == 34 &&
                     craftSlotId3[8] == 34)) {
                    craftItemId3 = 105;
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
            ...
            case 1196://snow block
                if ((craftSlotId3[0] == 299 && craftSlotId3[1] == 299 && craftSlotId3[3] == 299 &&
                     craftSlotId3[4] == 299) ||
                    (craftSlotId3[1] == 299 && craftSlotId3[2] == 299 && craftSlotId3[4] == 299 &&
                     craftSlotId3[5] == 299) ||
                    (craftSlotId3[3] == 299 && craftSlotId3[4] == 299 && craftSlotId3[6] == 299 &&
                     craftSlotId3[7] == 299) ||
                    (craftSlotId3[4] == 299 && craftSlotId3[5] == 299 && craftSlotId3[7] == 299 &&
                     craftSlotId3[8] == 299)) {
                    craftItemId3 = 47;
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
            ...
            case 28: //stonesand from sand
                if ((craftSlotId3[0] == 28 && craftSlotId3[1] == 28 && craftSlotId3[3] == 28 &&
                     craftSlotId3[4] == 28) ||
                    (craftSlotId3[1] == 28 && craftSlotId3[2] == 28 && craftSlotId3[4] == 28 &&
                     craftSlotId3[5] == 28) ||
                    (craftSlotId3[3] == 28 && craftSlotId3[4] == 28 && craftSlotId3[6] == 28 &&
                     craftSlotId3[7] == 28) ||
                    (craftSlotId3[4] == 28 && craftSlotId3[5] == 28 && craftSlotId3[7] == 28 &&
                     craftSlotId3[8] == 28)) {
                    craftItemId3 = 26;
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
            ...
            case 1156: //brick block
                if ((craftSlotId3[0] == 289 && craftSlotId3[1] == 289 && craftSlotId3[3] == 289 &&
                     craftSlotId3[4] == 289) ||
                    (craftSlotId3[1] == 289 && craftSlotId3[2] == 289 && craftSlotId3[4] == 289 &&
                     craftSlotId3[5] == 289) ||
                    (craftSlotId3[3] == 289 && craftSlotId3[4] == 289 && craftSlotId3[6] == 289 &&
                     craftSlotId3[7] == 289) ||
                    (craftSlotId3[4] == 289 && craftSlotId3[5] == 289 && craftSlotId3[7] == 289 &&
                     craftSlotId3[8] == 289)) {
                    craftItemId3 = 27;
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
            ...
            case 12: //stonebricks
                if ((craftSlotId3[0] == 3 && craftSlotId3[1] == 3 && craftSlotId3[3] == 3 && craftSlotId3[4] == 3) ||
                    (craftSlotId3[1] == 3 && craftSlotId3[2] == 3 && craftSlotId3[4] == 3 && craftSlotId3[5] == 3) ||
                    (craftSlotId3[3] == 3 && craftSlotId3[4] == 3 && craftSlotId3[6] == 3 && craftSlotId3[7] == 3) ||
                    (craftSlotId3[4] == 3 && craftSlotId3[5] == 3 && craftSlotId3[7] == 3 && craftSlotId3[8] == 3)) {
                    craftItemId3 = 102;
                    craftItemSt3 = 1;
                    craftItemAm3 = 4;
                }
            ...
            case 553://torches
                if ((craftSlotId3[0] == 277 && craftSlotId3[3] == 276) ||
                    (craftSlotId3[1] == 277 && craftSlotId3[4] == 276) ||
                    (craftSlotId3[2] == 277 && craftSlotId3[5] == 276) ||
                    (craftSlotId3[3] == 277 && craftSlotId3[6] == 276) ||
                    (craftSlotId3[4] == 277 && craftSlotId3[7] == 276) ||
                    (craftSlotId3[5] == 277 && craftSlotId3[8] == 276)) {
                    craftItemId3 = 308;
                    craftItemSt3 = 1;
                    craftItemAm3 = 4;
                }
            ...
            case 383://jack o'lantern
                if ((craftSlotId3[0] == Pumpkin3::getID() && craftSlotId3[3] == TorchItem::getID()) ||
                    (craftSlotId3[1] == Pumpkin3::getID() && craftSlotId3[4] == TorchItem::getID()) ||
                    (craftSlotId3[2] == Pumpkin3::getID() && craftSlotId3[5] == TorchItem::getID()) ||
                    (craftSlotId3[3] == Pumpkin3::getID() && craftSlotId3[6] == TorchItem::getID()) ||
                    (craftSlotId3[4] == Pumpkin3::getID() && craftSlotId3[7] == TorchItem::getID()) ||
                    (craftSlotId3[5] == Pumpkin3::getID() && craftSlotId3[8] == TorchItem::getID())) {
            ...
            case 556://scissors
                if ((craftSlotId3[1] == 278 && craftSlotId3[3] == 278) ||
                    (craftSlotId3[2] == 278 && craftSlotId3[4] == 278) ||
                    (craftSlotId3[4] == 278 && craftSlotId3[6] == 278) ||
                    (craftSlotId3[5] == 278 && craftSlotId3[7] == 278)) {
                    craftItemId3 = 275;
                    craftItemSt3 = 0;
                    craftItemAm3 = 239;
                }
            ...
            case 1132://clay
                if ((craftSlotId3[0] == 283 && craftSlotId3[1] == 283 && craftSlotId3[3] == 283 &&
                     craftSlotId3[4] == 283) ||
                    (craftSlotId3[1] == 283 && craftSlotId3[2] == 283 && craftSlotId3[4] == 283 &&
                     craftSlotId3[5] == 283) ||
                    (craftSlotId3[3] == 283 && craftSlotId3[4] == 283 && craftSlotId3[6] == 283 &&
                     craftSlotId3[7] == 283) ||
                    (craftSlotId3[4] == 283 && craftSlotId3[5] == 283 && craftSlotId3[7] == 283 &&
                     craftSlotId3[8] == 283)) {
                    craftItemId3 = 99;
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
            ...
            case 108://cobblestone
                if ((craftSlotId3[0] == 36 && craftSlotId3[1] == 36 && craftSlotId3[2] == 36) ||
                    (craftSlotId3[3] == 36 && craftSlotId3[4] == 36 && craftSlotId3[5] == 36) ||
                    (craftSlotId3[6] == 36 && craftSlotId3[7] == 36 && craftSlotId3[8] == 36)) {
                    craftItemId3 = 83;
                    craftItemSt3 = 1;
                    craftItemAm3 = 6;
                }
            ...
            case 9://stone
                if ((craftSlotId3[0] == 3 && craftSlotId3[1] == 3 && craftSlotId3[2] == 3) ||
                    (craftSlotId3[3] == 3 && craftSlotId3[4] == 3 && craftSlotId3[5] == 3) ||
                    (craftSlotId3[6] == 3 && craftSlotId3[7] == 3 && craftSlotId3[8] == 3)) {
                    craftItemId3 = 85;
                    craftItemSt3 = 1;
                    craftItemAm3 = 6;
                }
            ...
            case 78://stonesand half block
                if ((craftSlotId3[0] == 26 && craftSlotId3[1] == 26 && craftSlotId3[2] == 26) ||
                    (craftSlotId3[3] == 26 && craftSlotId3[4] == 26 && craftSlotId3[5] == 26) ||
                    (craftSlotId3[6] == 26 && craftSlotId3[7] == 26 && craftSlotId3[8] == 26)) {
                    craftItemId3 = 86;
                    craftItemSt3 = 1;
                    craftItemAm3 = 6;
                }
            ...
            case 306: //stonebrick half block
                if ((craftSlotId3[0] == 102 && craftSlotId3[1] == 102 && craftSlotId3[2] == 102) ||
                    (craftSlotId3[3] == 102 && craftSlotId3[4] == 102 && craftSlotId3[5] == 102) ||
                    (craftSlotId3[6] == 102 && craftSlotId3[7] == 102 && craftSlotId3[8] == 102)) {
                    craftItemId3 = 108;
                    craftItemSt3 = 1;
                    craftItemAm3 = 6;
                }
            ...
            case 903://mooshroom bowl
                if ((craftSlotId3[1] == 300 && craftSlotId3[4] == 301 && craftSlotId3[7] == 302) ||
                    (craftSlotId3[1] == 301 && craftSlotId3[4] == 300 && craftSlotId3[7] == 302)) {
                    craftItemId3 = 303;
                    craftItemSt3 = 0;
                    craftItemAm3 = 1;
                }
            ...
            case 654:
                if (craftSlotId3[1] == 34 && craftSlotId3[4] == 276 && craftSlotId3[7] == 276 &&
                    craftSlotId3[0] == 34 && craftSlotId3[2] == 34) // pick
                {
                    craftItemId3 = 250;
                    craftItemSt3 = 0;
                    craftItemAm3 = 60;
                ...
                if (craftSlotId3[0] == 34 && craftSlotId3[4] == 276 && craftSlotId3[7] == 276 &&
                    craftSlotId3[1] == 34 && craftSlotId3[3] == 34) // axe
                {
                    craftItemId3 = 265;
                    craftItemSt3 = 0;
                    craftItemAm3 = 60;
            ...
            case 620:
                ...
                if ((craftSlotId3[0] == 155 && craftSlotId3[1] == 155 && craftSlotId3[3] == 155 &&
                    ...
                    (craftSlotId3[1] == 155 && craftSlotId3[2] == 155 && craftSlotId3[4] == 155 &&
                     craftSlotId3[5] == 155) ||
                    (craftSlotId3[3] == 155 && craftSlotId3[4] == 155 && craftSlotId3[6] == 155 &&
                     craftSlotId3[7] == 155) ||
                    (craftSlotId3[4] == 155 && craftSlotId3[5] == 155 && craftSlotId3[7] == 155 &&
                     craftSlotId3[8] == 155)) {
                    craftItemId3 = 105;
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
            ...
            case 344:
                ...
                //wooden tools (birch)
            case 1017:
                if (craftSlotId3[1] == 155 && craftSlotId3[4] == 276 && craftSlotId3[7] == 276 &&
                    craftSlotId3[0] == 155 && craftSlotId3[2] == 155) // pick
                {
                    craftItemId3 = 250;
                    craftItemSt3 = 0;
                    craftItemAm3 = 60;
                ...
                if (craftSlotId3[0] == 155 && craftSlotId3[4] == 276 && craftSlotId3[7] == 276 &&
                    craftSlotId3[1] == 155 && craftSlotId3[3] == 155) // axe
                {
                    craftItemId3 = 265;
                    craftItemSt3 = 0;
                    craftItemAm3 = 60;
            ...
            case 707:
                ...
                //wooden tools (spruce)
            case 1020:
                if (craftSlotId3[1] == 156 && craftSlotId3[4] == 276 && craftSlotId3[7] == 276 &&
                    craftSlotId3[0] == 156 && craftSlotId3[2] == 156) // pick
                {
                    craftItemId3 = 250;
                    craftItemSt3 = 0;
                    craftItemAm3 = 60;
                ...
                if (craftSlotId3[0] == 156 && craftSlotId3[4] == 276 && craftSlotId3[7] == 276 &&
                    craftSlotId3[1] == 156 && craftSlotId3[3] == 156) // axe
                {
                    craftItemId3 = 265;
                    craftItemSt3 = 0;
                    craftItemAm3 = 60;
            ...
            case 660:
                if (craftSlotId3[1] == 36 && craftSlotId3[4] == 276 && craftSlotId3[7] == 276 &&
                    craftSlotId3[0] == 36 && craftSlotId3[2] == 36) {
                    craftItemId3 = 251;
                    craftItemSt3 = 0;
                    craftItemAm3 = 132;

                }
                if (craftSlotId3[0] == 36 && craftSlotId3[4] == 276 && craftSlotId3[7] == 276 &&
                    craftSlotId3[1] == 36 && craftSlotId3[3] == 36) {
                    craftItemId3 = 266;
                    craftItemSt3 = 0;
                    craftItemAm3 = 132;
            ...
            case 624:
                ...
                if ((craftSlotId3[0] == 156 && craftSlotId3[1] == 156 && craftSlotId3[3] == 156 &&
                    ...
                    (craftSlotId3[1] == 156 && craftSlotId3[2] == 156 && craftSlotId3[4] == 156 &&
                     craftSlotId3[5] == 156) ||
                    (craftSlotId3[3] == 156 && craftSlotId3[4] == 156 && craftSlotId3[6] == 156 &&
                     craftSlotId3[7] == 156) ||
                    (craftSlotId3[4] == 156 && craftSlotId3[5] == 156 && craftSlotId3[7] == 156 &&
                     craftSlotId3[8] == 156)) {
                    craftItemId3 = 105;
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
            ...
            case 1386:
                if (craftSlotId3[1] == 278 && craftSlotId3[4] == 276 && craftSlotId3[7] == 276 &&
                    craftSlotId3[0] == 278 && craftSlotId3[2] == 278) {
                    craftItemId3 = 252;
                    craftItemSt3 = 0;
                    craftItemAm3 = 251;

                }
                if (craftSlotId3[0] == 278 && craftSlotId3[4] == 276 && craftSlotId3[7] == 276 &&
                    craftSlotId3[1] == 278 && craftSlotId3[3] == 278) {
                    craftItemId3 = 267;
                    craftItemSt3 = 0;
                    craftItemAm3 = 251;
            ...
            case 1389:
                if (craftSlotId3[1] == 279 && craftSlotId3[4] == 276 && craftSlotId3[7] == 276 &&
                    craftSlotId3[0] == 279 && craftSlotId3[2] == 279) {
                    craftItemId3 = 253;
                    craftItemSt3 = 0;
                    craftItemAm3 = 1562;

                }
                if (craftSlotId3[0] == 279 && craftSlotId3[4] == 276 && craftSlotId3[7] == 276 &&
                    craftSlotId3[1] == 279 && craftSlotId3[3] == 279) {
                    craftItemId3 = 268;
                    craftItemSt3 = 0;
                    craftItemAm3 = 1562;
            ...
            case 834:
                ...
                if ((craftSlotId3[0] == 278 && craftSlotId3[4] == 278 && craftSlotId3[2] == 278) ||
                    (craftSlotId3[3] == 278 && craftSlotId3[7] == 278 && craftSlotId3[5] == 278)) {
                    craftItemId3 = 290;
                    craftItemSt3 = 0;
                    craftItemAm3 = 1;
                }
            ...
            case 1392:
                if (craftSlotId3[1] == 280 && craftSlotId3[4] == 276 && craftSlotId3[7] == 276 &&
                    craftSlotId3[0] == 280 && craftSlotId3[2] == 280) {
                    craftItemId3 = 254;
                    craftItemSt3 = 0;
                    craftItemAm3 = 33;

                }
                if (craftSlotId3[0] == 280 && craftSlotId3[4] == 276 && craftSlotId3[7] == 276 &&
                    craftSlotId3[1] == 280 && craftSlotId3[3] == 280) {
                    craftItemId3 = 269;
                    craftItemSt3 = 0;
                    craftItemAm3 = 33;
            ...
            case 1112:
                ...
                if ((craftSlotId3[0] == 278 && craftSlotId3[2] == 278 && craftSlotId3[3] == 278 &&
                     craftSlotId3[5] == 278) ||
                    (craftSlotId3[3] == 278 && craftSlotId3[5] == 278 && craftSlotId3[6] == 278 &&
                     craftSlotId3[8] == 278)) {
                    craftItemId3 = 339;
                    craftItemAm3 = 195;
                    craftItemSt3 = false;
            ...
            case 836:
                ...
                // helmet
            case 1615:
                if ((craftSlotId3[0] == 323 && craftSlotId3[1] == 323 && craftSlotId3[2] == 323 &&
                     craftSlotId3[3] == 323 && craftSlotId3[5] == 323) ||
                    (craftSlotId3[3] == 323 && craftSlotId3[4] == 323 && craftSlotId3[5] == 323 &&
                     craftSlotId3[6] == 323 && craftSlotId3[8] == 323)) {
                    craftItemId3 = 328;
                    craftItemAm3 = 55;
                    craftItemSt3 = false;
                }
                ...
                // chestplate
            case 2584:
                if (craftSlotId3[0] == 323 && craftSlotId3[2] == 323 && craftSlotId3[3] == 323 &&
                    craftSlotId3[4] == 323 && craftSlotId3[5] == 323 && craftSlotId3[6] == 323 &&
                    craftSlotId3[7] == 323 && craftSlotId3[8] == 323) {
                    craftItemId3 = 329;
                    craftItemAm3 = 80;
                    craftItemSt3 = false;
                }
            ...
            case 2261:
                if (craftSlotId3[0] == 323 && craftSlotId3[1] == 323 && craftSlotId3[2] == 323 &&
                    craftSlotId3[3] == 323 && craftSlotId3[5] == 323 && craftSlotId3[6] == 323 &&
                    craftSlotId3[8] == 323) {
                    craftItemId3 = 330;
                    craftItemAm3 = 75;
                    craftItemSt3 = false;
            ...
            case 1390:
                if ((craftSlotId3[0] == 278 && craftSlotId3[1] == 278 && craftSlotId3[2] == 278 &&
                     craftSlotId3[3] == 278 && craftSlotId3[5] == 278) ||
                    (craftSlotId3[3] == 278 && craftSlotId3[4] == 278 && craftSlotId3[5] == 278 &&
                     craftSlotId3[6] == 278 && craftSlotId3[8] == 278)) {
                    craftItemId3 = 336;
                    craftItemAm3 = 165;
                    craftItemSt3 = false;
                }
            ...
            case 2224:
                if (craftSlotId3[0] == 278 && craftSlotId3[2] == 278 && craftSlotId3[3] == 278 &&
                    craftSlotId3[4] == 278 && craftSlotId3[5] == 278 && craftSlotId3[6] == 278 &&
                    craftSlotId3[7] == 278 && craftSlotId3[8] == 278) {
                    craftItemId3 = 337;
                    craftItemAm3 = 240;
                    craftItemSt3 = false;
                }
            ...
            case 1946:
                ...
                // helmet
            case 1395:
                if ((craftSlotId3[0] == 279 && craftSlotId3[1] == 279 && craftSlotId3[2] == 279 &&
                     craftSlotId3[3] == 279 && craftSlotId3[5] == 279) ||
                    (craftSlotId3[3] == 279 && craftSlotId3[4] == 279 && craftSlotId3[5] == 279 &&
                     craftSlotId3[6] == 279 && craftSlotId3[8] == 279)) {
                    craftItemId3 = 340;
                    craftItemAm3 = 363;
                    craftItemSt3 = false;
                }
                ...
                // chestplate
            case 2232:
                if (craftSlotId3[0] == 279 && craftSlotId3[2] == 279 && craftSlotId3[3] == 279 &&
                    craftSlotId3[4] == 279 && craftSlotId3[5] == 279 && craftSlotId3[6] == 279 &&
                    craftSlotId3[7] == 279 && craftSlotId3[8] == 279) {
                    craftItemId3 = 341;
                    craftItemAm3 = 528;
                    craftItemSt3 = false;
                }
            ...
            case 1953:
                if (craftSlotId3[0] == 279 && craftSlotId3[1] == 279 && craftSlotId3[2] == 279 &&
                    craftSlotId3[3] == 279 && craftSlotId3[5] == 279 && craftSlotId3[6] == 279 &&
                    craftSlotId3[8] == 279) {
                    craftItemId3 = 342;
                    craftItemAm3 = 495;
                    craftItemSt3 = false;
            ...
            case 1116:
                ...
                // helmet
            case 1400:
                if ((craftSlotId3[0] == 280 && craftSlotId3[1] == 280 && craftSlotId3[2] == 280 &&
                     craftSlotId3[3] == 280 && craftSlotId3[5] == 280) ||
                    (craftSlotId3[3] == 280 && craftSlotId3[4] == 280 && craftSlotId3[5] == 280 &&
                     craftSlotId3[6] == 280 && craftSlotId3[8] == 280)) {
                    craftItemId3 = 344;
                    craftItemAm3 = 77;
                    craftItemSt3 = false;
                }
                ...
                // chestplate
            case 2240:
                if (craftSlotId3[0] == 280 && craftSlotId3[2] == 280 && craftSlotId3[3] == 280 &&
                    craftSlotId3[4] == 280 && craftSlotId3[5] == 280 && craftSlotId3[6] == 280 &&
                    craftSlotId3[7] == 280 && craftSlotId3[8] == 280) {
                    craftItemId3 = 345;
                    craftItemAm3 = 112;
                    craftItemSt3 = false;
                }
            ...
            case 1960:
                if (craftSlotId3[0] == 280 && craftSlotId3[1] == 280 && craftSlotId3[2] == 280 &&
                    craftSlotId3[3] == 280 && craftSlotId3[5] == 280 && craftSlotId3[6] == 280 &&
                    craftSlotId3[8] == 280) {
                    craftItemId3 = 346;
                    craftItemAm3 = 105;
                    craftItemSt3 = false;
            ...
            case 2862: //lapis block
                if (craftSlotId3[0] == 318 && craftSlotId3[1] == 318 && craftSlotId3[2] == 318 &&
                    craftSlotId3[3] == 318 && craftSlotId3[4] == 318 && craftSlotId3[5] == 318 &&
                    craftSlotId3[6] == 318 && craftSlotId3[7] == 318 && craftSlotId3[8] == 318) {
                    craftItemId3 = 101;
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
                }
            ...
            case 101: //lapis block to items
                if (craftSlotId3[0] == 101 || craftSlotId3[1] == 101 || craftSlotId3[2] == 101 ||
                    craftSlotId3[3] == 101 || craftSlotId3[4] == 101 || craftSlotId3[5] == 101 ||
                    craftSlotId3[6] == 101 || craftSlotId3[7] == 101 || craftSlotId3[8] == 101) {
                    craftItemId3 = 318;
                    craftItemSt3 = 1;
                    craftItemAm3 = 9;
                }
            ...
            case 66: //iron block to bars
                if (craftSlotId3[0] == 66 || craftSlotId3[1] == 66 || craftSlotId3[2] == 66 || craftSlotId3[3] == 66 ||
                    craftSlotId3[4] == 66 || craftSlotId3[5] == 66 || craftSlotId3[6] == 66 || craftSlotId3[7] == 66 ||
                    craftSlotId3[8] == 66) {
                    craftItemId3 = 278;
                    craftItemSt3 = 1;
                    craftItemAm3 = 9;
            ...
            case 2520: //gold block
                if (craftSlotId3[0] == 280 && craftSlotId3[1] == 280 && craftSlotId3[2] == 280 &&
                    craftSlotId3[3] == 280 && craftSlotId3[4] == 280 && craftSlotId3[5] == 280 &&
                    craftSlotId3[6] == 280 && craftSlotId3[7] == 280 && craftSlotId3[8] == 280) {
                    craftItemId3 = 65;
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
                }
            ...
            case 65: //gold block to bars
                if (craftSlotId3[0] == 65 || craftSlotId3[1] == 65 || craftSlotId3[2] == 65 || craftSlotId3[3] == 65 ||
                    craftSlotId3[4] == 65 || craftSlotId3[5] == 65 || craftSlotId3[6] == 65 || craftSlotId3[7] == 65 ||
                    craftSlotId3[8] == 65) {
                    craftItemId3 = 280;
                    craftItemSt3 = 1;
                    craftItemAm3 = 9;
            ...
            case 2511: //diamond block
                if (craftSlotId3[0] == 279 && craftSlotId3[1] == 279 && craftSlotId3[2] == 279 &&
                    craftSlotId3[3] == 279 && craftSlotId3[4] == 279 && craftSlotId3[5] == 279 &&
                    craftSlotId3[6] == 279 && craftSlotId3[7] == 279 && craftSlotId3[8] == 279) {
                    craftItemId3 = 64;
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
                }
            ...
            case 64: //diamond block to diamonds
                if (craftSlotId3[0] == 64 || craftSlotId3[1] == 64 || craftSlotId3[2] == 64 || craftSlotId3[3] == 64 ||
                    craftSlotId3[4] == 64 || craftSlotId3[5] == 64 || craftSlotId3[6] == 64 || craftSlotId3[7] == 64 ||
                    craftSlotId3[8] == 64) {
                    craftItemId3 = 279;
                    craftItemSt3 = 1;
                    craftItemAm3 = 9;
            ...
            case 2583: //hay bale
                if (craftSlotId3[0] == Wheat::getID() && craftSlotId3[1] == Wheat::getID() &&
                    craftSlotId3[2] == Wheat::getID() && craftSlotId3[3] == Wheat::getID() &&
                    craftSlotId3[4] == Wheat::getID() &&
                    craftSlotId3[5] == Wheat::getID() && craftSlotId3[6] == Wheat::getID() &&
                    craftSlotId3[7] == Wheat::getID() && craftSlotId3[8] == Wheat::getID()) {
            ...
            case 213: //hay bale to wheat
                if (craftSlotId3[0] == HayBale::getID() || craftSlotId3[1] == HayBale::getID() ||
                    craftSlotId3[2] == HayBale::getID() || craftSlotId3[3] == HayBale::getID() ||
                    craftSlotId3[4] == HayBale::getID() ||
                    craftSlotId3[5] == HayBale::getID() || craftSlotId3[6] == HayBale::getID() ||
                    craftSlotId3[7] == HayBale::getID() || craftSlotId3[8] == HayBale::getID()) {
            ...
            case 2493: //coal to coal block
                if (craftSlotId3[0] == Coal::getID() && craftSlotId3[1] == Coal::getID() &&
                    craftSlotId3[2] == Coal::getID() && craftSlotId3[3] == Coal::getID() &&
                    craftSlotId3[4] == Coal::getID() &&
                    craftSlotId3[5] == Coal::getID() && craftSlotId3[6] == Coal::getID() &&
                    craftSlotId3[7] == Coal::getID() && craftSlotId3[8] == Coal::getID()) {
            ...
            case 214: //coal block to coal
                if (craftSlotId3[0] == CoalBlock::getID() || craftSlotId3[1] == CoalBlock::getID() ||
                    craftSlotId3[2] == CoalBlock::getID() || craftSlotId3[3] == CoalBlock::getID() ||
                    craftSlotId3[4] == CoalBlock::getID() ||
                    craftSlotId3[5] == CoalBlock::getID() || craftSlotId3[6] == CoalBlock::getID() ||
                    craftSlotId3[7] == CoalBlock::getID() || craftSlotId3[8] == CoalBlock::getID()) {
            ...
            case 3177: //redstone to redstone block
                if (craftSlotId3[0] == Redstone::getID() && craftSlotId3[1] == Redstone::getID() &&
                    craftSlotId3[2] == Redstone::getID() && craftSlotId3[3] == Redstone::getID() &&
                    craftSlotId3[4] == Redstone::getID() &&
                    craftSlotId3[5] == Redstone::getID() && craftSlotId3[6] == Redstone::getID() &&
                    craftSlotId3[7] == Redstone::getID() && craftSlotId3[8] == Redstone::getID()) {
            ...
            case 215: //redstonee block to redstone
                if (craftSlotId3[0] == RedstoneBlock::getID() || craftSlotId3[1] == RedstoneBlock::getID() ||
                    craftSlotId3[2] == RedstoneBlock::getID() || craftSlotId3[3] == RedstoneBlock::getID() ||
                    craftSlotId3[4] == RedstoneBlock::getID() ||
                    craftSlotId3[5] == RedstoneBlock::getID() || craftSlotId3[6] == RedstoneBlock::getID() ||
                    craftSlotId3[7] == RedstoneBlock::getID() || craftSlotId3[8] == RedstoneBlock::getID()) {
            ...
            case 1932: //ladder
                if (craftSlotId3[0] == 276 && craftSlotId3[2] == 276 && craftSlotId3[3] == 276 &&
                    craftSlotId3[4] == 276 && craftSlotId3[5] == 276 && craftSlotId3[6] == 276 &&
                    craftSlotId3[8] == 276) {
                    craftItemId3 = 307;
                    craftItemSt3 = 1;
                    craftItemAm3 = 3;
            ...
            case 1240: //chest (birch)
                if (craftSlotId3[1] == 155 && craftSlotId3[2] == 155 && craftSlotId3[3] == 155 &&
                    craftSlotId3[5] == 155 && craftSlotId3[7] == 155 && craftSlotId3[0] == 155 &&
                    craftSlotId3[6] == 155 && craftSlotId3[8] == 155) {
                    craftItemId3 = ChestBlock3::getID();
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
                }
            ...
            case 1248: //chest (spruce)
                if (craftSlotId3[1] == 156 && craftSlotId3[2] == 156 && craftSlotId3[3] == 156 &&
                    craftSlotId3[5] == 156 && craftSlotId3[7] == 156 && craftSlotId3[0] == 156 &&
                    craftSlotId3[6] == 156 && craftSlotId3[8] == 156) {
                    craftItemId3 = ChestBlock3::getID();
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
                }
            ...
            case 288: //furnace
                if (craftSlotId3[1] == 36 && craftSlotId3[2] == 36 && craftSlotId3[3] == 36 && craftSlotId3[5] == 36 &&
                    craftSlotId3[7] == 36 && craftSlotId3[0] == 36 && craftSlotId3[6] == 36 && craftSlotId3[8] == 36) {
            ...
            case 861: //bread
                if ((craftSlotId3[0] == 287 && craftSlotId3[1] == 287 && craftSlotId3[2] == 287) ||
                    (craftSlotId3[3] == 287 && craftSlotId3[4] == 287 && craftSlotId3[5] == 287) ||
                    (craftSlotId3[6] == 287 && craftSlotId3[7] == 287 && craftSlotId3[8] == 287)) {
                    craftItemId3 = 288;
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
                }
            ...
            case 888: //cookies
                if ((craftSlotId3[0] == 287 && craftSlotId3[1] == 314 && craftSlotId3[2] == 287) ||
                    (craftSlotId3[3] == 287 && craftSlotId3[4] == 314 && craftSlotId3[5] == 287) ||
                    (craftSlotId3[6] == 287 && craftSlotId3[7] == 314 && craftSlotId3[8] == 287)) {
                    craftItemId3 = 315;
                    craftItemSt3 = 1;
                    craftItemAm3 = 8;
                }
            ...
            case 2524: //golden apple
                if (craftSlotId3[0] == 280 && craftSlotId3[1] == 280 && craftSlotId3[2] == 280 &&
                    craftSlotId3[3] == 280 && craftSlotId3[4] == 284 && craftSlotId3[5] == 280 &&
                    craftSlotId3[6] == 280 && craftSlotId3[7] == 280 && craftSlotId3[8] == 280) {
                    craftItemId3 = 285;
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
            ...
            case 891: //book
                if ((craftSlotId3[0] == 297 && craftSlotId3[3] == 297 && craftSlotId3[6] == 297) ||
                    (craftSlotId3[1] == 297 && craftSlotId3[4] == 297 && craftSlotId3[7] == 297) ||
                    (craftSlotId3[2] == 297 && craftSlotId3[5] == 297 && craftSlotId3[8] == 297)) {
                    craftItemId3 = 298;
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
                }
            ...
            case 1098: //book shelf
                if (craftSlotId3[0] == 34 && craftSlotId3[1] == 34 && craftSlotId3[2] == 34 && craftSlotId3[3] == 298 &&
                    craftSlotId3[4] == 298 && craftSlotId3[5] == 298 && craftSlotId3[6] == 34 &&
                    craftSlotId3[7] == 34 && craftSlotId3[8] == 34) {
                    craftItemId3 = 35;
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
            ...
            case 1734: //book shelf (birch)
                if (craftSlotId3[0] == 155 && craftSlotId3[1] == 155 && craftSlotId3[2] == 155 &&
                    craftSlotId3[3] == 298 && craftSlotId3[4] == 298 && craftSlotId3[5] == 298 &&
                    craftSlotId3[6] == 155 && craftSlotId3[7] == 155 && craftSlotId3[8] == 155) {
                    craftItemId3 = 35;
                    craftItemSt3 = 1;
                    craftItemAm3 = 1;
            ...
            case 1473: //clock
                if (craftSlotId3[1] == 280 && craftSlotId3[3] == 280 && craftSlotId3[4] == Redstone::getID() &&
                    craftSlotId3[5] == 280 && craftSlotId3[7] == 280) {
            ...
            case 1465: //compass
                if (craftSlotId3[1] == IronBar::getID() && craftSlotId3[3] == IronBar::getID() &&
                    craftSlotId3[4] == Redstone::getID() && craftSlotId3[5] == IronBar::getID() &&
                    craftSlotId3[7] == IronBar::getID()) {
            ...
            case 2531: //item frame
                if (craftSlotId3[1] == Stick::getID() && craftSlotId3[2] == Stick::getID() &&
                    craftSlotId3[3] == Stick::getID() &&
                    craftSlotId3[5] == Stick::getID() && craftSlotId3[7] == Stick::getID() &&
                    craftSlotId3[0] == Stick::getID() &&
                    craftSlotId3[6] == Stick::getID() && craftSlotId3[8] == Stick::getID() &&
                    craftSlotId3[4] == Leather::getID()) {
            ...
            case 1788: //TNT
                if (craftSlotId3[1] == SandBlock::getID() && craftSlotId3[2] == Gunpowder::getID() &&
                    craftSlotId3[3] == SandBlock::getID() &&
                    craftSlotId3[5] == SandBlock::getID() && craftSlotId3[7] == SandBlock::getID() &&
                    craftSlotId3[0] == Gunpowder::getID() &&
                    craftSlotId3[6] == Gunpowder::getID() && craftSlotId3[8] == Gunpowder::getID() &&
                    craftSlotId3[4] == Gunpowder::getID()) {
            ...
            case 75: //pumpkin to pumpkin seeds
                if (craftSlotId3[0] == 75 || craftSlotId3[1] == 75 || craftSlotId3[2] == 75 && craftSlotId3[3] == 75 ||
                    craftSlotId3[4] == 75 || craftSlotId3[5] == 75 || craftSlotId3[6] == 75 || craftSlotId3[7] == 75 ||
                    craftSlotId3[8] == 75) {
        ...
        if (menuState == 0)//game state
        {
            if (invEn == false && craft3xEn == false && chestEn == false && furnaceEn == false) {
                        ...
                        if (mWorld->invId[27 + barPosition] > 0) {
                            ...
                            if (mWorld->invSt[27 + barPosition] == true) {
                                if (mWorld->invAm[27 + barPosition] > 0) {
                                    ...
                                    mWorld->DropThisNoAlign(mWorld->invId[27 + barPosition], 1,
                                                            mWorld->invSt[27 + barPosition],
                                                            Vector3(fppCam->m_vPosition.x,
                                                                    fppCam->m_vPosition.y - 0.25f,
                                                                    fppCam->m_vPosition.z), dropVelocity);
                                ...
                                mWorld->DropThisNoAlign(mWorld->invId[27 + barPosition],
                                                        mWorld->invAm[27 + barPosition],
                                                        mWorld->invSt[27 + barPosition],
                                                        Vector3(fppCam->m_vPosition.x, fppCam->m_vPosition.y - 0.25f,
                                                                fppCam->m_vPosition.z), dropVelocity);
                ...
                if (sleepTime == 0.0f) {
                    ...
                    if (keyHold(InputHelper::Instance()->getButtonToAction(12))) {
                        dStd = -1;
                        if (headInWater || headInLava || mWorld->BlockAtPoint(
                                Vector3(playerPosition.x, playerPosition.y - 0.65f, playerPosition.z)) ==
                                                         WaterBlock::getID() || mWorld->BlockAtPoint(
                                Vector3(playerPosition.x, playerPosition.y - 0.65f, playerPosition.z)) ==
                                                                                Lava::getID()) {
                        ...
                        if (headInWater == false && headInLava == false && walkingOnGround == false &&
                            (footInWater == true || footInLava == true))    //Your above he water, so Jump out
                        {
                ...
                /* if (mSystemMgr->KeyPressed(PSP_CTRL_RTRIGGER)) //open inventory
            {
                ...
                if (keyPressed(InputHelper::Instance()->getButtonToAction(14))) {
                    ...
                    BoundingBox collider = mWorld->blockTypes[mWorld->GetBlock(testPos.x, testPos.y,
                                                                               testPos.z)].collideBox;
                    BoundingBox testBox = BoundingBox(testPos.x + collider.min.x, testPos.y + collider.min.y,
                                                      testPos.z + collider.min.z, testPos.x + collider.max.x,
                                                      testPos.y + collider.max.y, testPos.z + collider.max.z);


                    if (mWorld->invId[27 + barPosition] == Scissors::getID() ||
                        (mWorld->ItemType(mWorld->invId[27 + barPosition]) == ItemType::dye &&
                         mWorld->invId[27 + barPosition] != BoneMeal::getID())) // shear sheep or dye it
                    {
                        if (mWorld->mSheeps.empty() == false) {
                            for (float i = 0; i < 5.25f; i += 0.1f) {
                                ...
                                for (int f = 0; f < mWorld->mSheeps.size(); f++) {
                                    ...
                                    if (TestSheep->DistanceToPlayer() < 2.85 && TestSheep->kicked == false &&
                                        TestSheep->damaged == false) {
                                        if (TestSheep->bBox.contains(testPos)) {
                                            if (mWorld->ItemType(mWorld->invId[27 + barPosition]) ==
                                                ItemType::dye) // dye item
                                            {
                                                int newColor = 14;
                                            ...
                                            if (mWorld->invId[27 + barPosition] == Scissors::getID()) {
                                                if (TestSheep->sheared == false) {
                                                    ...
                                                    for (int i = 0; i < woolNum; i++) {
                                                        mWorld->DropThis(
                                                                BlackWoolBlock::getID() + TestSheep->GetFurColor(), 1,
                                                                true, Vector3(TestSheep->position.x,
                                                                              TestSheep->position.y + 0.3f,
                                                                              TestSheep->position.z));
                                                    }
                    ...
                    for (float i = 0; i < 5.25f; i += 0.1f) {
                        ...
                        testBox = BoundingBox(floorf(testPos.x) + 0.5f + collider.min.x,
                                              floorf(testPos.y) + 0.5f + collider.min.y,
                                              floorf(testPos.z) + 0.5f + collider.min.z,
                                              floorf(testPos.x) + 0.5f + collider.max.x,
                                              floorf(testPos.y) + 0.5f + collider.max.y,
                                              floorf(testPos.z) + 0.5f + collider.max.z);
                            ...
                            if (selectedBlock == Lava::getID()) {
                                ...
                                if (walkingOnGround == false) {
                                    playerBox = BoundingBox(
                                            Vector3(playerPosition.x - (mWorld->playerCollisionSize - 0.03f),
                                                    playerPosition.y - 1.63f,
                                                    playerPosition.z - (mWorld->playerCollisionSize - 0.03)),
                                            Vector3(playerPosition.x + (mWorld->playerCollisionSize - 0.03),
                                                    playerPosition.y + 0.2f,
                                                    playerPosition.z + (mWorld->playerCollisionSize - 0.03)));
                                } else {
                                    playerBox = BoundingBox(
                                            Vector3(playerPosition.x - (mWorld->playerCollisionSize - 0.03f),
                                                    playerPosition.y - 1.59f,
                                                    playerPosition.z - (mWorld->playerCollisionSize - 0.03)),
                                            Vector3(playerPosition.x + (mWorld->playerCollisionSize - 0.03),
                                                    playerPosition.y + 0.2f,
                                                    playerPosition.z + (mWorld->playerCollisionSize - 0.03)));
                        ...
                        if (mWorld->invId[27 + barPosition] == 290) //busket
                        {
                            ...
                            {
                                // well simulation
                                if ((mWorld->GetBlock(testPos.x - 1, testPos.y, testPos.z) == 4 &&
                                     mWorld->GetBlock(testPos.x - 1, testPos.y, testPos.z - 1) == 4 &&
                                     mWorld->GetBlock(testPos.x, testPos.y, testPos.z - 1) == 4) ||
                                    (mWorld->GetBlock(testPos.x + 1, testPos.y, testPos.z) == 4 &&
                                     mWorld->GetBlock(testPos.x + 1, testPos.y, testPos.z - 1) == 4 &&
                                     mWorld->GetBlock(testPos.x, testPos.y, testPos.z - 1) == 4) ||
                                    (mWorld->GetBlock(testPos.x - 1, testPos.y, testPos.z) == 4 &&
                                     mWorld->GetBlock(testPos.x - 1, testPos.y, testPos.z + 1) == 4 &&
                            ...
                            {
                                // well simulation
                                if ((mWorld->GetBlock(testPos.x - 1, testPos.y, testPos.z) == Lava::getID() &&
                                     mWorld->GetBlock(testPos.x - 1, testPos.y, testPos.z - 1) == Lava::getID() &&
                                     mWorld->GetBlock(testPos.x, testPos.y, testPos.z - 1) == Lava::getID()) ||
                                    (mWorld->GetBlock(testPos.x + 1, testPos.y, testPos.z) == Lava::getID() &&
                                     mWorld->GetBlock(testPos.x + 1, testPos.y, testPos.z - 1) == Lava::getID() &&
                                     mWorld->GetBlock(testPos.x, testPos.y, testPos.z - 1) == Lava::getID()) ||
                                    (mWorld->GetBlock(testPos.x - 1, testPos.y, testPos.z) == Lava::getID() &&
                                     mWorld->GetBlock(testPos.x - 1, testPos.y, testPos.z + 1) == Lava::getID() &&
                        ...
                        if (mWorld->BlockEditable(testPos.x, testPos.y, testPos.z) && testBox.contains(testPos)) {
                            ...
                            if (mWorld->invId[27 + barPosition] >= 270 && mWorld->invId[27 + barPosition] <= 274) {
                                if (selectedBlock == 1) //if it is grass
                                {
                                    ...
                                    if (mWorld->invAm[27 + barPosition] ==
                                        0) //destroy tool if it has 0 durability points
                                    {
                                        mWorld->invAm[27 + barPosition] = -1;
                                        mWorld->invId[27 + barPosition] = -1;
                                        mWorld->invSt[27 + barPosition] = 0;
                            ...
                            if (selectedBlock == NoteBlock::getID()) {
                                ...
                                if (noteBlockId != -1) {
                                    if (mWorld->GetBlock(testPos.x, testPos.y + 1, testPos.z) == 0) {
                                        ...
                                        mSoundMgr->PlayNoteSound(
                                                !(mWorld->BlockMaterial(testPos.x, testPos.y - 1, testPos.z) == 1 ||
                                                  mWorld->BlockMaterial(testPos.x, testPos.y - 1, testPos.z) == 8),
                                                TestNoteBlock->GetPitch());
                                        ...
                                        Particle *Note = new Particle(mWorld, "note", Vector3((int) testPos.x + 0.5f,
                                                                                              (int) testPos.y + 1.1f,
                                                                                              (int) testPos.z + 0.5f));
                                ...
                                if (itemFrameId != -1)  // set item in item frame
                                {
                                    ...
                                    if (TestItemFrame->GetItem() != -1)  // remove item in item frame
                                    {
                                        if (TestItemFrame->GetItem() < 250) {
                                            mWorld->DropThis(TestItemFrame->GetItem(), 1, true,
                                                             Vector3((int) testPos.x + 0.5f, (int) testPos.y + 0.5f,
                                                                     (int) testPos.z + 0.5f));
                                        } else {
                                            if (TestItemFrame->GetAmount() != -1) {
                                                mWorld->DropThis(TestItemFrame->GetItem(), TestItemFrame->GetAmount(),
                                                                 mWorld->StackableItem(TestItemFrame->GetItem()),
                                                                 Vector3((int) testPos.x + 0.5f, (int) testPos.y + 0.5f,
                                                                         (int) testPos.z + 0.5f));
                                            } else {
                                                if (TestItemFrame->GetItem() >= 250) {
                                                    mWorld->DropThis(TestItemFrame->GetItem(), 1,
                                                                     mWorld->StackableItem(TestItemFrame->GetItem()),
                                                                     Vector3((int) testPos.x + 0.5f,
                                                                             (int) testPos.y + 0.5f,
                                                                             (int) testPos.z + 0.5f));
                                                } else {
                                                    mWorld->DropThis(TestItemFrame->GetItem(), 1, true,
                                ...
                                if (jukeboxId != -1) {
                                    if (mWorld->GetBlock(testPos.x, testPos.y + 1, testPos.z) == 0) {
                                        ...
                                        if (TestJukebox->GetRecord() == -1) {
                                            if ((mWorld->invId[27 + barPosition] >= Disk1::getID() &&
                                                 mWorld->invId[27 + barPosition] <= Disk3::getID()) ||
                                                (mWorld->invId[27 + barPosition] >= Disk4::getID() &&
                                                 mWorld->invId[27 + barPosition] <= Disk12::getID())) {
                                                ...
                                                if (mWorld->invId[27 + barPosition] >= Disk4::getID() &&
                                                    mWorld->invId[27 + barPosition] <= Disk12::getID()) {
                                                ...
                                                switch (music_number) {
                                                    case 0:
                                                        inputDiskName = "C418 - 13";
                                                        break;
                                                    case 1:
                                                        inputDiskName = "C418 - cat";
                                                        break;
                                                    case 2:
                                                        inputDiskName = "C418 - blocks";
                                                        break;
                                                    case 3:
                                                        inputDiskName = "C418 - chirp";
                                                        break;
                                                    case 4:
                                                        inputDiskName = "C418 - far";
                                                        break;
                                                    case 5:
                                                        inputDiskName = "C418 - mall";
                                                        break;
                                                    case 6:
                                                        inputDiskName = "C418 - mellohi";
                                                        break;
                                                    case 7:
                                                        inputDiskName = "C418 - stal";
                                                        break;
                                                    case 8:
                                                        inputDiskName = "C418 - strad";
                                                        break;
                                                    case 9:
                                                        inputDiskName = "C418 - ward";
                                                        break;
                                                    case 10:
                                                        inputDiskName = "C418 - 11";
                                                        break;
                                                    case 11:
                                                        inputDiskName = "C418 - wait";
                                                        break;
                                                }
                                            ...
                                            mWorld->DropThis(TestJukebox->GetRecord(), 1, false,
                                                             Vector3((int) testPos.x + 0.5f, (int) testPos.y + 1.0f,
                                                                     (int) testPos.z + 0.5f));
                            ...
                            if (mWorld->invId[27 + barPosition] == BoneMeal::getID()) {
                                                ...
                                                if (mWorld->GetBlock(xx, yy, zz) != 0) {
                                                    if (mWorld->GetBlock(xx, yy, zz) == GrassBlock::getID()) {
                                                        if (mWorld->GetBlock(xx, yy + 1, zz) == 0) {
                                                            if (rand() % 10 <= 5) {
                                                                rand() % 2 == 0 ? mWorld->GetBlock(xx, yy + 1,
                                                                                                   zz) = Flower1::getID()
                                                                                : mWorld->GetBlock(xx, yy + 1,
                                                                                                   zz) = Flower2::getID();
                                                                if (rand() % 2 == 0) {
                                                                    mWorld->GetBlock(xx, yy + 1,
                                                                                     zz) = TallGrass::getID();
                                ...
                                if (selectedBlock >= PumpkinPlant1::getID() &&
                                    selectedBlock <= PumpkinPlant3::getID()) {
                            ...
                            if (mWorld->blockTypes[mWorld->GetBlock(testPos.x, testPos.y, testPos.z)].blockModel == 1 &&
                                ...
                                if (testPos.y - y > 0.4f) {
                                    ...
                                    if (!blockBox.intersect(playerBox)) {
                                        switch (mWorld->invId[27 + barPosition]) {
                                            case 82 :
                                                mWorld->GetBlock(testPos.x, testPos.y, testPos.z) = OakPlanks::getID();
                                                break;
                                            case 83 :
                                                mWorld->GetBlock(testPos.x, testPos.y,
                                                                 testPos.z) = CobbleStone::getID();
                                                break;
                                            case 84 :
                                                mWorld->GetBlock(testPos.x, testPos.y, testPos.z) = BrickBlock::getID();
                                                break;
                                            case 85 :
                                                mWorld->GetBlock(testPos.x, testPos.y, testPos.z) = DoubleSlab::getID();
                                                break;
                                            case 86 :
                                                mWorld->GetBlock(testPos.x, testPos.y, testPos.z) = SandStone::getID();
                                                break;
                                            case 108 :
                                                mWorld->GetBlock(testPos.x, testPos.y, testPos.z) = StoneBrick::getID();
                                                break;
                                            case 157 :
                                                mWorld->GetBlock(testPos.x, testPos.y,
                                                                 testPos.z) = BirchPlanks::getID();
                                                break;
                                            case 158 :
                                                mWorld->GetBlock(testPos.x, testPos.y,
                                                                 testPos.z) = SprucePlanks::getID();
                                                break;
                                        }

                                        mSoundMgr->PlayWalkSound(
                                                mWorld->blockTypes[mWorld->invId[27 + barPosition]].soundType);
                            ...
                            if (selectedBlock >= TrapdoorClosed1::getID() &&
                                selectedBlock <= TrapdoorClosed4::getID()) //door
                            {
                                ...
                                if (!doorBox.intersect(playerBox)) {
                                    mWorld->GetBlock(testPos.x, testPos.y, testPos.z) =
                                            mWorld->GetBlock(testPos.x, testPos.y, testPos.z) - 4;
                            ...
                            if (selectedBlock >= TrapdoorOpen1::getID() &&
                                selectedBlock <= TrapdoorOpen4::getID()) //door
                            {
                                //check if player dont stand inside the door block
                                int x = (int) testPos.x;
                                int y = (int) testPos.y;
                            ...
                            if (selectedBlock == 57) //door
                            {
                                ...
                                if (!doorBox.intersect(playerBox)) {
                                    if (mWorld->GetBlock(testPos.x, testPos.y - 1, testPos.z) >= 49 &&
                                        mWorld->GetBlock(testPos.x, testPos.y - 1, testPos.z) <= 52) //door
                                    {
                                        mWorld->GetBlock(testPos.x, testPos.y - 1, testPos.z) =
                                                mWorld->GetBlock(testPos.x, testPos.y - 1, testPos.z) + 4;
                                        mWorld->GetBlock(testPos.x, testPos.y, testPos.z) = 58;
                                        mSoundMgr->PlayDoorSound(true);

                                        int curchunkTarget = mWorld->getChunkId(
                                                Vector3(testPos.x, testPos.y - 1, testPos.z));
                                        fppCam->needUpdate = true;
                                        mWorld->RebuildTransparentMeshChunk(curchunkTarget);
                                        return;
                                    }
                            ...
                            if (selectedBlock == 58) //door
                            {
                                ...
                                if (!doorBox.intersect(playerBox)) {
                                    if (mWorld->GetBlock(testPos.x, testPos.y - 1, testPos.z) >= 53 &&
                                        mWorld->GetBlock(testPos.x, testPos.y - 1, testPos.z) <= 56) //door
                                    {
                                        mWorld->GetBlock(testPos.x, testPos.y - 1, testPos.z) =
                                                mWorld->GetBlock(testPos.x, testPos.y - 1, testPos.z) - 4;
                            ...
                            if (selectedBlock == TNTBlock::getID() &&
                                mWorld->invId[27 + barPosition] == FlintAndSteel::getID())//TNT explosion
                            {
                                mWorld->SpawnTNTentity(((int) testPos.x) + 0.5f, ((int) testPos.y) + 0.5f,
                                                       ((int) testPos.z) + 0.5f);
                                mWorld->GetBlock(testPos.x, testPos.y, testPos.z) = 0;
                            ...
                            if (selectedBlock == ChestBlock1::getID() || selectedBlock == ChestBlock2::getID() ||
                                selectedBlock == ChestBlock3::getID() || selectedBlock == ChestBlock4::getID()) {
                            ...
                            if (selectedBlock >= BedBlock1::getID() && selectedBlock <= BedBlock8::getID() &&
                                ...
                                if (mWorld->mZombies.empty() == false) {
                                    for (int f = 0; f < mWorld->mZombies.size(); f++) {
                                        ...
                                        if (abs(playerPosition.x - TestZombie->position.x) <= 7 &&
                                            abs(playerPosition.z - TestZombie->position.z) <= 7 &&
                                            abs(playerPosition.y - TestZombie->position.y) <= 4) {
                                            sleepMessageTime = 3.0f;
                                            sleepMessageType = 2;
                                            break;
                                        }
                                ...
                                mWorld->playerSpawnPointPosition = Vector3((int) mWorld->playerPos.x + 0.5f,
                                                                           mWorld->playerPos.y,
                                                                           (int) mWorld->playerPos.z + 0.5f);
                                sleepTime = 4.6f;
                                ...
                                if (selectedBlock == BedBlock1::getID() || selectedBlock == BedBlock5::getID()) {
                                    ...
                                    fppCam->PositionCamera(playerPosition.x, playerPosition.y, playerPosition.z,
                                                           playerPosition.x - 5.0f, playerPosition.y, playerPosition.z,
                                                           0.0f, 1.0f, 0.0f);
                                ...
                                if (selectedBlock == BedBlock3::getID() || selectedBlock == BedBlock7::getID()) {
                                    ...
                                    fppCam->PositionCamera(playerPosition.x, playerPosition.y, playerPosition.z,
                                                           playerPosition.x, playerPosition.y, playerPosition.z - 5.0f,
                                                           0.0f, 1.0f, 0.0f);
                            ...
                            BoundingBox testBox2 = BoundingBox(
                                    Vector3(cubePos.x - 0.5f, cubePos.y - 0.5f, cubePos.z - 0.5f),
                                    Vector3(cubePos.x + 0.5f, cubePos.y + 0.5f, cubePos.z + 0.5f));
                            ...
                            if (distance != -1.0f) {
                                ...
                                if (mWorld->GetBlock(testPos2.x, testPos2.y, testPos2.z) == Lava::getID() ||
                                    ...
                                    BoundingBox blockBox = BoundingBox(Vector3(boxX, boxY, boxZ),
                                                                       Vector3(boxX + 1, boxY + 1, boxZ + 1));
                                    BoundingBox playerBox;
                                    if (walkingOnGround == false) {
                                        playerBox = BoundingBox(
                                                Vector3(playerPosition.x - (mWorld->playerCollisionSize - 0.03f),
                                    ...
                                    if (!blockBox.intersect(playerBox) ||
                                        ...
                                        if (mWorld->CanPutBlockHere(testPos2.x, testPos2.y, testPos2.z,
                                                                    mWorld->invId[27 + barPosition])) {
                                            bool wasLight = false;
                                            int oldBlock = mWorld->invId[27 + barPosition];

                                            if (mWorld->LightSourceBlock(mWorld->invId[27 + barPosition])) {
                                                wasLight = true;
                                                mWorld->SetLigtSourcePosition(testPos2.x, testPos2.y, testPos2.z,
                                                                              mWorld->invId[27 + barPosition]);
                                            }

                                            if (mWorld->GetBlock(testPos2.x, testPos2.y, testPos2.z) == Lava::getID()) {
                                                wasLight = true;
                                                mWorld->RemoveLigtSourceAtPosition(testPos2.x, testPos2.y, testPos2.z,
                                                                                   112);
                                                mWorld->GetBlock(testPos2.x, testPos2.y, testPos2.z) = 0;
                                            }
                                            ...
                                            {
                                                if (mWorld->invId[27 + barPosition] >= BlackWoolCarpet::getID() &&
                                                    mWorld->invId[27 + barPosition] <=
                                                    WhiteWoolCarpet::getID()) // if carpet in our hands
                                                {
                                                    if (mWorld->BlockSpecial(testPos2.x, testPos2.y - 1, testPos2.z) !=
                                                        2) {
                                                        if (mWorld->BlockSpecial(testPos2.x, testPos2.y - 1,
                                                                                 testPos2.z) != 0 ||
                                                            mWorld->BlockSolid(testPos2.x, testPos2.y - 1,
                                                                               testPos2.z) == false) {
                                                            return;
                                                        }
                                                    }
                                                ...
                                                if (mWorld->invId[27 + barPosition] ==
                                                    NoteBlock::getID()) // if we are putting note block
                                                {
                                                    NoteBlockEntity *NewNoteBlockEntity = new NoteBlockEntity(
                                                            testPos2.x, testPos2.y, testPos2.z, 12);
                                                    mWorld->mNoteBlocks.push_back(NewNoteBlockEntity);
                                                }

                                                if (mWorld->invId[27 + barPosition] ==
                                                    JukeBox::getID()) // if we are putting jukebox
                                                {
                                                    JukeboxEntity *NewJukeboxEntity = new JukeboxEntity(testPos2.x,
                                                                                                        testPos2.y,
                                                                                                        testPos2.z, -1);
                                                ...
                                                if (mWorld->invId[27 + barPosition] ==
                                                    ChestBlock3::getID()) // if we are putting chest
                                                {
                                                ...
                                                if (mWorld->invId[27 + barPosition] ==
                                                    FurnaceOff::getID()) // if we are putting chest
                                                {
                                                    Furnace *NewFurnace = new Furnace(testPos2.x, testPos2.y,
                                                                                      testPos2.z);
                                                ...
                                                if (mWorld->invId[27 + barPosition] != -1) //multi-texturing blocks
                                                {
                                                    ...
                                                    switch (mWorld->invId[27 + barPosition]) {
                                                        case 75:
                                                            if (fppCam->horAngle > 45 && fppCam->horAngle < 135) {
                                                                mWorld->GetBlock(testPos2.x, testPos2.y,
                                                                                 testPos2.z) = 75;
                                                            }
                                                            if (fppCam->horAngle > 225 && fppCam->horAngle < 315) {
                                                                mWorld->GetBlock(testPos2.x, testPos2.y,
                                                            ...
                                                            if (mWorld->GetBlock(testPos2.x, testPos2.y, testPos2.z) ==
                                                                0) {
                                                                mWorld->GetBlock(testPos2.x, testPos2.y,
                                                                                 testPos2.z) = 73;
                                                            }
                                                        ...
                                                        case 151:
                                                            if (fppCam->horAngle > 45 && fppCam->horAngle < 135) {
                                                                if (mWorld->BlockSolid(testPos2.x, testPos2.y,
                                                                                       testPos2.z + 1)) {
                                                                    mWorld->GetBlock(testPos2.x, testPos2.y,
                                                                                     testPos2.z) = 154; // 3
                                                                } else {
                                                            ...
                                                            if (fppCam->horAngle < 45 || fppCam->horAngle > 315) {
                                                                if (mWorld->BlockSolid(testPos2.x + 1, testPos2.y,
                                                                                       testPos2.z)) {
                                                                    mWorld->GetBlock(testPos2.x, testPos2.y,
                                                                                     testPos2.z) = 152; // 1
                                                                } else {
                                            ...
                                            {
                                                if (mWorld->invId[27 + barPosition] ==
                                                    TorchItem::getID()) // if it is torch
                                                {
                                                    if (mWorld->BlockSolid(testPos2.x + 1, testPos2.y, testPos2.z) ==
                                                        true ||
                                                        mWorld->BlockSolid(testPos2.x - 1, testPos2.y, testPos2.z) ==
                                                        true ||
                                                        mWorld->BlockSolid(testPos2.x, testPos2.y, testPos2.z - 1) ==
                                                        true ||
                                                        mWorld->BlockSolid(testPos2.x, testPos2.y, testPos2.z + 1) ==
                                                        true ||
                                                        mWorld->BlockSolid(testPos2.x, testPos2.y - 1, testPos2.z) ==
                                                        true) {
                                                        ...
                                                        wasLight = true;
                                                        mWorld->SetLigtSourcePosition(testPos2.x, testPos2.y,
                                                                                      testPos2.z,
                                                                                      mWorld->invId[27 + barPosition]);
                                                    } else {
                                                        return;
                                                ...
                                                if (mWorld->invId[27 + barPosition] ==
                                                    WheatSeeds::getID()) // if it is seeds
                                                {
                                                    if (mWorld->GetBlock(testPos2.x, testPos2.y - 1, testPos2.z) ==
                                                        79 ||
                                                        mWorld->GetBlock(testPos2.x, testPos2.y - 1, testPos2.z) ==
                                                        80) // planting seeds
                                                    {
                                                ...
                                                if (mWorld->invId[27 + barPosition] ==
                                                    MelonSeeds::getID()) // if it is melon seeds
                                                {
                                                    if (mWorld->GetBlock(testPos2.x, testPos2.y - 1, testPos2.z) ==
                                                        Soil::getID() ||
                                                        mWorld->GetBlock(testPos2.x, testPos2.y - 1, testPos2.z) ==
                                                        WateredSoil::getID()) // planting seeds
                                                    {
                                                        mWorld->GetBlock(testPos2.x, testPos2.y,
                                                                         testPos2.z) = MelonPlant1::getID();
                                                        fppCam->needUpdate = true;
                                                ...
                                                if (mWorld->invId[27 + barPosition] ==
                                                    PumpkinSeeds::getID()) // if it is pumpkin seeds
                                                {
                                                    if (mWorld->GetBlock(testPos2.x, testPos2.y - 1, testPos2.z) ==
                                                        Soil::getID() ||
                                                        mWorld->GetBlock(testPos2.x, testPos2.y - 1, testPos2.z) ==
                                                    ...
                                                    {
                                                        mWorld->GetBlock(testPos2.x, testPos2.y,
                                                                         testPos2.z) = PumpkinPlant1::getID();
                                                        fppCam->needUpdate = true;
                                                ...
                                                if (mWorld->invId[27 + barPosition] == Potato::getID()) {
                                                        ...
                                                        WateredSoil::getID()) // planting seeds
                                                    {
                                                        ...
                                                        mWorld->RebuildTransparentMeshChunk(
                                                                mWorld->getChunkId(testPos2));
                                                ...
                                                if (mWorld->invId[27 + barPosition] ==
                                                    GlassPanelItem::getID()) // if it is glass panel
                                                {
                                                    mWorld->GetBlock(testPos2.x, testPos2.y,
                                                                     testPos2.z) = GlassPanel::getID();
                                                ...
                                                if (mWorld->invId[27 + barPosition] ==
                                                    IronBarsItem::getID()) // if it is iron bars,kw
                                                {
                                                    mWorld->GetBlock(testPos2.x, testPos2.y,
                                                                     testPos2.z) = IronBars::getID();
                                                ...
                                                if (mWorld->invId[27 + barPosition] >= 300 &&
                                                    mWorld->invId[27 + barPosition] <= 301) // if it is moshrooms
                                                {
                                                    mWorld->GetBlock(testPos2.x, testPos2.y, testPos2.z) =
                                                            77 + (mWorld->invId[27 + barPosition] - 300);
                                                    fppCam->needUpdate = true;
                                                ...
                                                if (mWorld->invId[27 + barPosition] >= 294 &&
                                                    mWorld->invId[27 + barPosition] <=
                                                    296) // if it is flowers or saplings
                                                {
                                                    if (mWorld->GetBlock(testPos2.x, testPos2.y - 1, testPos2.z) == 1 ||
                                                        mWorld->GetBlock(testPos2.x, testPos2.y - 1, testPos2.z) ==
                                                        2) // if under is dirt or grass
                                                    {
                                                        mWorld->GetBlock(testPos2.x, testPos2.y, testPos2.z) = 119 +
                                                                                                               (mWorld->invId[
                                                                                                                        27 +
                                                                                                                        barPosition] -
                                                ...
                                                if (mWorld->invId[27 + barPosition] == 309 ||
                                                    mWorld->invId[27 + barPosition] == 310) // if it is another sapling
                                                {
                                                    if (mWorld->GetBlock(testPos2.x, testPos2.y - 1, testPos2.z) == 1 ||
                                                        mWorld->GetBlock(testPos2.x, testPos2.y - 1, testPos2.z) == 2 ||
                                                        mWorld->GetBlock(testPos2.x, testPos2.y - 1, testPos2.z) ==
                                                        29) // if under is dirt or grass
                                                    {
                                                ...
                                                if (mWorld->invId[27 + barPosition] == 306) // if it is door item
                                                {
                                                    if (mWorld->GetBlock(testPos2.x, testPos2.y + 1, testPos2.z) == 0) {
                                                        if (fppCam->horAngle > 45 && fppCam->horAngle < 135) {
                                                            mWorld->GetBlock(testPos2.x, testPos2.y,
                                                                             testPos2.z) = 49; // 3
                                                            mWorld->GetBlock(testPos2.x, testPos2.y + 1,
                                                                             testPos2.z) = 57;
                                                        }
                                                        if (fppCam->horAngle > 225 && fppCam->horAngle < 315) {
                                                            mWorld->GetBlock(testPos2.x, testPos2.y,
                                                ...
                                                if (mWorld->invId[27 + barPosition] ==
                                                    BedItem::getID()) // if it is door item
                                                {
                                                    bool placed = false;
                                                    if (fppCam->horAngle < 45 || fppCam->horAngle > 315) {

                                                        if (mWorld->GetBlock(testPos2.x + 1, testPos2.y, testPos2.z) ==
                                                            0) {
                                                            mWorld->GetBlock(testPos2.x, testPos2.y,
                                                                             testPos2.z) = BedBlock1::getID(); // 3
                                                            mWorld->GetBlock(testPos2.x + 1, testPos2.y,
                                                                             testPos2.z) = BedBlock5::getID();
                                                    ...
                                                    if (fppCam->horAngle > 135 && fppCam->horAngle < 225) {
                                                        ...
                                                        if (mWorld->GetBlock(testPos2.x - 1, testPos2.y, testPos2.z) ==
                                                            0) {
                                                            mWorld->GetBlock(testPos2.x, testPos2.y,
                                                                             testPos2.z) = BedBlock2::getID(); // 3
                                                            mWorld->GetBlock(testPos2.x - 1, testPos2.y,
                                                                             testPos2.z) = BedBlock6::getID();

                                                            placed = true;
                                                        }
                                                    }
                                                    if (fppCam->horAngle > 45 && fppCam->horAngle < 135) {
                                                        if (mWorld->GetBlock(testPos2.x, testPos2.y, testPos2.z + 1) ==
                                                            0) {
                                                            mWorld->GetBlock(testPos2.x, testPos2.y,
                                                                             testPos2.z) = BedBlock3::getID(); // 3
                                                            mWorld->GetBlock(testPos2.x, testPos2.y,
                                                                             testPos2.z + 1) = BedBlock7::getID();
                                                    ...
                                                    if (fppCam->horAngle > 225 && fppCam->horAngle < 315) {
                                                        if (mWorld->GetBlock(testPos2.x, testPos2.y, testPos2.z - 1) ==
                                                            0) {
                                                            mWorld->GetBlock(testPos2.x, testPos2.y,
                                                                             testPos2.z) = BedBlock4::getID(); // 3
                                                            mWorld->GetBlock(testPos2.x, testPos2.y,
                                                                             testPos2.z - 1) = BedBlock8::getID();
                                                ...
                                                if (mWorld->invId[27 + barPosition] ==
                                                    ItemFrameItem::getID()) // if it is door item
                                                {
                                                    bool placed = false;
                                                    ...
                                                    if (placed) {
                                                        ItemFrameEntity *NewItemFrameEntity = new ItemFrameEntity(
                                                                testPos2.x, testPos2.y, testPos2.z, facing);
                                                ...
                                                if (mWorld->invId[27 + barPosition] == 307) // if it is ladder item
                                                {
                                                    ...
                                                    if (fppCam->horAngle > 45 && fppCam->horAngle < 135) {
                                                        if (mWorld->GetBlock(testPos2.x, testPos2.y, testPos2.z + 1) !=
                                                            0 && mWorld->BlockSolid(testPos2.x, testPos2.y,
                                                                                    testPos2.z + 1) == true) {
                                                            mWorld->GetBlock(testPos2.x, testPos2.y,
                                                                             testPos2.z) = 90; // 3
                                                            placed = true;
                                                    ...
                                                    if (fppCam->horAngle < 45 || fppCam->horAngle > 315) {
                                                        if (mWorld->GetBlock(testPos2.x + 1, testPos2.y, testPos2.z) !=
                                                            0 && mWorld->BlockSolid(testPos2.x + 1, testPos2.y,
                                                                                    testPos2.z) == true) {
                                                ...
                                                {
                                                    if (mWorld->GetBlock(testPos2.x, testPos2.y - 1, testPos2.z) ==
                                                        7) //check if under is sand
                                                    {
                                                        if (mWorld->GetBlock(testPos2.x - 1, testPos2.y - 1,
                                                                             testPos2.z) == 4 ||
                                                            mWorld->GetBlock(testPos2.x + 1, testPos2.y - 1,
                                                                             testPos2.z) == 4 ||
                                                            mWorld->GetBlock(testPos2.x, testPos2.y - 1,
                                                                             testPos2.z + 1) == 4 ||
                                                            mWorld->GetBlock(testPos2.x, testPos2.y - 1,
                                            ...
                                            if (wasLight == true) {
                                                ...
                                                if (!wasUpdated) {
                                                    if (mWorld->GetLightLevel(testPos2.x, testPos2.y, testPos2.z) !=
                                                        0) {
                                                        mWorld->UpdateLightAreaIn(testPos2);
                                                    }
                                                    ...
                                                    if (mWorld->BlockTransparent(testPos2.x, testPos2.y, testPos2.z) ||
                                                        mWorld->GetBlock(testPos2.x, testPos2.y, testPos2.z) ==
                                                        WoodenFence::getID()) {
                                                        mWorld->rebuildNearestChunks(chunkTarget, testPos2);
                                                    }
                ...
                if (keyPressed(InputHelper::Instance()->getButtonToAction(13)) || tryToDt == true) {
                    ...
                    BoundingBox collider = mWorld->blockTypes[mWorld->GetBlock(testPos2.x, testPos2.y,
                                                                               testPos2.z)].collideBox;
                    BoundingBox testBox = BoundingBox(testPos2.x + collider.min.x, testPos2.y + collider.min.y,
                                                      testPos2.z + collider.min.z, testPos2.x + collider.max.x,
                                                      testPos2.y + collider.max.y, testPos2.z + collider.max.z);
                    ...
                    for (float i = 0; i < 5.25f; i += 0.1f) {
                        ...
                        testBox = BoundingBox(floorf(testPos2.x) + 0.5f + collider.min.x,
                                              floorf(testPos2.y) + 0.5f + collider.min.y,
                                              floorf(testPos2.z) + 0.5f + collider.min.z,
                                              floorf(testPos2.x) + 0.5f + collider.max.x,
                                              floorf(testPos2.y) + 0.5f + collider.max.y,
                                              floorf(testPos2.z) + 0.5f + collider.max.z);

                        bool kick = false;
                        if (mWorld->mZombies.empty() == false) {
                            for (int f = 0; f < mWorld->mZombies.size(); f++) {
                                Zombie *TestZombie = mWorld->mZombies[f];
                                if (TestZombie->DistanceToPlayer() < 3.16f && TestZombie->kicked == false &&
                                    TestZombie->damaged == false) {
                        ...
                        if (mWorld->mCows.empty() == false) {
                            for (int f = 0; f < mWorld->mCows.size(); f++) {
                                ...
                                if (TestCow->DistanceToPlayer() < 2.75 && TestCow->kicked == false &&
                                    TestCow->damaged == false) {
                        ...
                        if (mWorld->mSheeps.empty() == false) {
                            for (int f = 0; f < mWorld->mSheeps.size(); f++) {
                                Sheep *TestSheep = mWorld->mSheeps[f];
                                if (TestSheep->DistanceToPlayer() < 2.75 && TestSheep->kicked == false &&
                                    TestSheep->damaged == false) {
                        ...
                        if (mWorld->mCreepers.empty() == false) {
                            for (int f = 0; f < mWorld->mCreepers.size(); f++) {
                                ...
                                if (mWorld->FastDistance2d(abs(TestCreeper->position.x - playerPosition.x) * 10,
                                                           abs(TestCreeper->position.z - playerPosition.z) * 10) /
                                    10.0f + abs(TestCreeper->position.y - (playerPosition.y - 0.7)) / 2.0f < 2.18 &&
                                    TestCreeper->kicked == false && TestCreeper->damaged == false) {
                        ...
                        if (mWorld->BlockEditable(testPos2.x, testPos2.y, testPos2.z) && testBox.contains(testPos2)) {
                            if (mWorld->GetBlock(testPos2.x, testPos2.y, testPos2.z) == NoteBlock::getID()) {
                                ...
                                if (noteBlockId != -1) {
                                    if (mWorld->GetBlock(testPos2.x, testPos2.y + 1, testPos2.z) == 0) {
                                        NoteBlockEntity *TestNoteBlock = mWorld->mNoteBlocks[noteBlockId];
                                        mSoundMgr->PlayNoteSound(
                                                !(mWorld->BlockMaterial(testPos2.x, testPos2.y - 1, testPos2.z) == 1 ||
                                                  mWorld->BlockMaterial(testPos2.x, testPos2.y - 1, testPos2.z) == 8),
                                                TestNoteBlock->GetPitch());
                                        ...
                                        Particle *Note = new Particle(mWorld, "note", Vector3((int) testPos2.x + 0.5f,
                                                                                              (int) testPos2.y + 1.1f,
                                                                                              (int) testPos2.z + 0.5f));
                                        Note->SetColor(Vector3(red, green, blue));
                                        mParticles.push_back(Note);
                            ...
                            if (startDt == false) {
                                ...
                                dET = 1.0f;
                                dT = 0.0f;
                                switch (mWorld->BlockMaterial(testPos1.x, testPos1.y,
                                                              testPos1.z)) // fetch time of block breaking
                                {
                                    case 1: // wood
                                        ...
                                        {
                                            dET = 0.5f;
                                        } else if (mWorld->invId[27 + barPosition] ==
                                                   DiamondAxe::getID()) // diamond axe
                                        {
                                            dET = 0.4f;
                ...
                if (keyHold(InputHelper::Instance()->getButtonToAction(13))) {
                    if (startDt == true) {
                        if (animGo == false) {
                            mSoundMgr->PlayDigSound(
                                    mWorld->BlockSoundAtPos(Vector3(testPos1.x, testPos1.y, testPos1.z)));
                        ...
                        if (dT >= dET) {
                            ...
                            if (oldBlock >= ChestBlock1::getID() &&
                                oldBlock <= ChestBlock4::getID()) // chest destroying
                            {
                                    ...
                                    for (int i = 0; i <= 27; i++) {
                                        if (TestChest->chestSlotId[i] > 0) {
                                            ...
                                            if (TestChest->chestSlotAm[i] > 0) {
                                                mWorld->DropThisNoAlign(TestChest->chestSlotId[i],
                                                                        TestChest->chestSlotAm[i],
                                                                        TestChest->chestSlotSt[i],
                                                                        Vector3(testPos1.x + 0.5f, testPos1.y + 0.25f,
                                                                                testPos1.z + 0.5f), dropVelocity);
                            ...
                            if (oldBlock == JukeBox::getID()) {
                                ...
                                if (jukeboxId != -1) {
                                    if (mWorld->mJukeboxes[jukeboxId]->GetRecord() != -1) {
                                        mWorld->DropThis(mWorld->mJukeboxes[jukeboxId]->GetRecord(), 1, false,
                                                         Vector3((int) testPos1.x + 0.5f, (int) testPos1.y + 0.5f,
                                                                 (int) testPos1.z + 0.5f));
                                    }
                                    ...
                                    for (int i = 0; i <= 2; i++) {
                                        if (TestFurnace->furnaceSlotId[i] > 0) {
                                            ...
                                            if (TestFurnace->furnaceSlotAm[i] > 0) {
                                                mWorld->DropThisNoAlign(TestFurnace->furnaceSlotId[i],
                                                                        TestFurnace->furnaceSlotAm[i],
                                                                        TestFurnace->furnaceSlotSt[i],
                                                                        Vector3(testPos1.x + 0.5f, testPos1.y + 0.25f,
                                                                                testPos1.z + 0.5f), dropVelocity);
                            ...
                            if (oldBlock == IceBlock::getID()) {
                                ...
                                if (upper_block != 0) {
                                    if (mWorld->BlockSolid(testPos1.x, testPos1.y + 1, testPos1.z) == false &&
                                        ...
                                        !(upper_block >= TrapdoorOpen1::getID() &&
                                          upper_block <= TrapdoorClosed4::getID())) {
                                        Vector3 testPos2 = Vector3(testPos1.x, testPos1.y + 1, testPos1.z);

                                        mWorld->DropThis(mWorld->BlockLoot(testPos2.x, testPos2.y, testPos2.z),
                                                         testPos2);
                                        mWorld->GetBlock(testPos2.x, testPos2.y, testPos2.z) = 0;
                            ...
                            if (mWorld->invId[27 + barPosition] >= 250 &&
                                mWorld->invId[27 + barPosition] <= 275) // tool breaking
                            {
                                mWorld->invAm[27 + barPosition] -= 1;
                                if (mWorld->invAm[27 + barPosition] <= 0) {
                                    Vector3 rayParticleDir = fppCam->m_vView - fppCam->m_vPosition;
                                    ...
                                    if (mParticles.size() <= 52) {
                                        for (int k = 0; k <= 5; k++) // 5 particles
                                        {
                                            Particle *ToolPart = new Particle(mWorld, "item crack",
                                                                              Vector3(particlePos.x,
                                                                                      particlePos.y - 0.18f,
                                                                                      particlePos.z));
                            ...
                            switch (oldBlock) {
                                ...
                                case 93: // snow cover
                                    if (mWorld->invId[27 + barPosition] >= 260 &&
                                        mWorld->invId[27 + barPosition] <= 264) {
                                ...
                                case 3: // stone
                                    if (mWorld->invId[27 + barPosition] >= WoodenPickaxe::getID() &&
                                        mWorld->invId[27 + barPosition] <= GoldenPickaxe::getID()) {
                                        mWorld->DropThis(mWorld->LootBlock(oldBlock), testPos1);
                                    }
                                    break;
                                ...
                                case 41: // iron ore
                                    if (mWorld->invId[27 + barPosition] >= StonePickaxe::getID() &&
                                        mWorld->invId[27 + barPosition] <= GoldenPickaxe::getID()) {
                                        mWorld->DropThis(mWorld->LootBlock(oldBlock), testPos1);
                                    }
                                    break;
                                ...
                                case 43: // diamond ore
                                    if (mWorld->invId[27 + barPosition] >= IronPickaxe::getID() &&
                                        mWorld->invId[27 + barPosition] <= GoldenPickaxe::getID()) {
                                        mWorld->DropThis(mWorld->LootBlock(oldBlock), testPos1);
                                    }
                                    break;
                            ...
                            if (mParticles.size() <= 52 && oldBlock >= 0) {
                                ...
                                {
                                    Particle *Smoke2 = new Particle(mWorld, "block crack",
                                                                    Vector3((int) testPos1.x + 0.5f +
                                                                            (-0.3 + (rand() % 7) * 0.1f),
                                                                            (int) testPos1.y + 0.5f +
                                                                            (-0.2 + (rand() % 5) * 0.1f),
                                                                            (int) testPos1.z + 0.5f +
                            ...
                            mWorld->CheckForTorchSupport(testPos1.x, testPos1.y, testPos1.z,
                                                         mWorld->GetBlock(testPos1.x, testPos1.y, testPos1.z));
                            ...
                            if (chunkTarget != -1) {
                                if (wasLight == true) {
                                    mWorld->RemoveLigtSourceAtPosition(testPos1.x, testPos1.y, testPos1.z,
                                                                       Torch::getID());
                    ...
                    if (invEn == true) {
                        for (int i = 0; i <= 3; i++) {
                            if (craftSlotId[i] > 0) {
                                ...
                                if (craftSlotAm[i] > 0) {
                                    mWorld->DropThisNoAlign(craftSlotId[i], craftSlotAm[i], craftSlotSt[i],
                                                            Vector3(fppCam->m_vPosition.x,
                                                                    fppCam->m_vPosition.y - 0.25f,
                                                                    fppCam->m_vPosition.z), dropVelocity);
                    ...
                    if (craft3xEn == true) {
                        for (int i = 0; i <= 8; i++) {
                            if (craftSlotId3[i] > 0) {
                                ...
                                if (craftSlotAm3[i] > 0) {
                                    mWorld->DropThisNoAlign(craftSlotId3[i], craftSlotAm3[i], craftSlotSt3[i],
                                                            Vector3(fppCam->m_vPosition.x,
                                                                    fppCam->m_vPosition.y - 0.25f,
                                                                    fppCam->m_vPosition.z), dropVelocity);
                    ...
                    if (invEn == true) // if 2x craft menu is open
                    {
                        if (craftItemId != -1) // if craft cell is not empty
                        {
                            if (mWorld->mId == craftItemId) // if item in craft cell = item in your mouse
                            {
                                ...
                                {
                                    if (mWorld->mAm + craftItemAm <=
                                        64) //if sum of item in you mouse and items in craft cell is lower or equal than 64
                                    {
                ...
                if (mSystemMgr->KeyPressed(PSP_CTRL_CROSS)) {
                    if (upEn == 0) {
                        if (armorEn == false) {
                                ...
                                if (mWorld->invId[invYPosition * 9 + invXPosition] == mWorld->mId) {
                                    if (mWorld->invSt[invYPosition * 9 + invXPosition] == 1) {
                                        if (mWorld->invAm[invYPosition * 9 + invXPosition] + mWorld->mAm < 64) {
                                            ...
                                            mWorld->mAm =
                                                    (mWorld->invAm[invYPosition * 9 + invXPosition] + mWorld->mAm) - 64;
                            ...
                            if (mWorld->mId == -1) {
                                if (mWorld->armorId[invYPosition * 2 + invXPosition] != 324 + invYPosition * 2 +
                                                                                        invXPosition) // 324+invYPosition*2+invXPosition is an id of sample armor item
                                {
                                    ...
                                    mWorld->armorId[invYPosition * 2 + invXPosition] =
                                            324 + invYPosition * 2 + invXPosition;
                                    mWorld->armorAm[invYPosition * 2 + invXPosition] = -1;
                                    mWorld->armorSt[invYPosition * 2 + invXPosition] = false;
                                }
                            } else {
                                if (mWorld->armorId[invYPosition * 2 + invXPosition] ==
                                    324 + invYPosition * 2 + invXPosition) {
                                    if (mWorld->mId == 324 + invYPosition * 2 + invXPosition + 4 ||
                                        /* all leather armor */
                                        mWorld->mId == 324 + invYPosition * 2 + invXPosition + 8 ||
                                        /* all chain armor */
                                        mWorld->mId == 324 + invYPosition * 2 + invXPosition + 12 ||
                                        /* all iron armor */
                                        mWorld->mId == 324 + invYPosition * 2 + invXPosition + 16 ||
                                        /* all diamond armor */
                                        mWorld->mId == 324 + invYPosition * 2 + invXPosition + 20 ||
                                        /* all golde armor */
                                        (invXPosition == 0 && invYPosition == 0 && mWorld->mId ==
                                                                                   Pumpkin3::getID()) /** it is pumpkin and cursor on helmet slot **/
                                ...
                                if (craftSlotId[invYPosition * 2 + invXPosition] == mWorld->mId) {
                                    if (craftSlotSt[invYPosition * 2 + invXPosition] == 1) {
                                        if (craftSlotAm[invYPosition * 2 + invXPosition] + mWorld->mAm < 64) {
                                            ...
                                            mWorld->mAm =
                                                    (craftSlotAm[invYPosition * 2 + invXPosition] + mWorld->mAm) - 64;
                                ...
                                if (craftSlotId3[invYPosition * 3 + invXPosition] == mWorld->mId) {
                                    if (craftSlotSt3[invYPosition * 3 + invXPosition] == 1) {
                                        if (craftSlotAm3[invYPosition * 3 + invXPosition] + mWorld->mAm < 64) {
                                            ...
                                            mWorld->mAm =
                                                    (craftSlotAm3[invYPosition * 3 + invXPosition] + mWorld->mAm) - 64;
                            ...
                            if (mWorld->mId == -1) {
                                ...
                                if (UseChest->chestSlotId[invYPosition * 9 + invXPosition] == mWorld->mId) {
                                    if (UseChest->chestSlotSt[invYPosition * 9 + invXPosition] == 1) {
                                        if (UseChest->chestSlotAm[+invYPosition * 9 + invXPosition] + mWorld->mAm <
                                            64) {
                                            UseChest->chestSlotAm[invYPosition * 9 + invXPosition] += mWorld->mAm;
                                            mWorld->mId = -1;
                                            mWorld->mAm = -1;
                        ...
                        if (mWorld->mId != -1) {
                            ...
                            if (mWorld->invId[invYPosition * 9 + invXPosition] != -1 &&
                                ...
                                if (mWorld->invAm[invYPosition * 9 + invXPosition] > 1) {
                                    mWorld->mId = mWorld->invId[invYPosition * 9 + invXPosition];
                                    mWorld->mAm = ceilf(
                                            (float) (mWorld->invAm[invYPosition * 9 + invXPosition] / 2.0f));
                                    mWorld->mSt = mWorld->invSt[invYPosition * 9 + invXPosition];

                                    mWorld->invAm[invYPosition * 9 + invXPosition] =
                                            mWorld->invAm[invYPosition * 9 + invXPosition] - mWorld->mAm;
                                }
                            }
                        }
                            ...
                            if (mWorld->mId != -1) {
                                ...
                                if (craftSlotId[invYPosition * 2 + invXPosition] != -1 &&
                                    ...
                                    if (craftSlotAm[invYPosition * 2 + invXPosition] > 1) {
                                        mWorld->mId = craftSlotId[invYPosition * 2 + invXPosition];
                                        mWorld->mAm = ceilf(
                                                (float) (craftSlotAm[invYPosition * 2 + invXPosition] / 2.0f));
                                        mWorld->mSt = craftSlotSt[invYPosition * 2 + invXPosition];

                                        craftSlotAm[invYPosition * 2 + invXPosition] =
                                                craftSlotAm[invYPosition * 2 + invXPosition] - mWorld->mAm;
                                    }
                                }
                            }
                            ...
                            if (mWorld->mId != -1) {
                                ...
                                if (craftSlotId3[invYPosition * 3 + invXPosition] != -1 &&
                                    ...
                                    if (craftSlotAm3[invYPosition * 3 + invXPosition] > 1) {
                                        mWorld->mId = craftSlotId3[invYPosition * 3 + invXPosition];
                                        mWorld->mAm = ceilf(
                                                (float) (craftSlotAm3[invYPosition * 3 + invXPosition] / 2.0f));
                                        mWorld->mSt = craftSlotSt3[invYPosition * 3 + invXPosition];

                                        craftSlotAm3[invYPosition * 3 + invXPosition] =
                                                craftSlotAm3[invYPosition * 3 + invXPosition] - mWorld->mAm;
                                    }
                                }
                            }
                            ...
                            if (mWorld->mId != -1) {
                                ...
                                if (UseChest->chestSlotId[invYPosition * 9 + invXPosition] != -1 &&
                                    ...
                                    if (UseChest->chestSlotAm[invYPosition * 9 + invXPosition] > 1) {
                                        mWorld->mId = UseChest->chestSlotId[invYPosition * 9 + invXPosition];
                                        mWorld->mAm = ceilf(
                                                (float) (UseChest->chestSlotAm[invYPosition * 9 + invXPosition] /
                                                         2.0f));
                                        mWorld->mSt = UseChest->chestSlotSt[invYPosition * 9 + invXPosition];

                                        UseChest->chestSlotAm[invYPosition * 9 + invXPosition] =
                                                UseChest->chestSlotAm[invYPosition * 9 + invXPosition] - mWorld->mAm;
                                    }
                                }
                            }
                            ...
                            if (mWorld->mId != -1) {
                                ...
                                if (UseFurnace->furnaceSlotId[invYPosition] != -1 &&
                                    ...
                                    if (UseFurnace->furnaceSlotAm[invYPosition] > 1) {
                                        ...
                                        UseFurnace->furnaceSlotAm[invYPosition] =
                                                UseFurnace->furnaceSlotAm[invYPosition] - mWorld->mAm;
                                    }
                                }
                            }
    ...
    if (mWorld->health <= 0) {
            ...
            for (int i = 0; i < 36; i++) {
                if (i <= 3) // drop armor items
                {
                    if (mWorld->armorId[i] != 324 + i) {
                        ...
                        mWorld->DropThisNoAlign(mWorld->armorId[i], mWorld->armorAm[i], mWorld->armorSt[i],
                                                Vector3(fppCam->m_vPosition.x, fppCam->m_vPosition.y - 0.25f,
                                                        fppCam->m_vPosition.z), dropVelocity);
                ...
                if (mWorld->invId[i] > 0) {
                    ...
                    if (mWorld->invAm[i] > 0) {
                        mWorld->DropThisNoAlign(mWorld->invId[i], mWorld->invAm[i], mWorld->invSt[i],
                                                Vector3(fppCam->m_vPosition.x, fppCam->m_vPosition.y - 0.25f,
                                                        fppCam->m_vPosition.z), dropVelocity);
        ...
        if (mSystemMgr->KeyPressed(PSP_CTRL_CROSS)) {
            if (mWorld->gameModeWorld == 2) {
                ...
                if (mWorld->BlockSolid(newPosition.x, newPosition.y - 1.2f, newPosition.z) ||
                    mWorld->BlockSolid(newPosition.x, newPosition.y, newPosition.z)) {
                    newPosition.y =
                            mWorld->groundHeight(newPosition.x, newPosition.z) + mWorld->playerGrowth - 0.05f + 1;
                }
                ...
                fppCam->PositionCamera(playerPosition.x, playerPosition.y, playerPosition.z, playerPosition.x,
                                       playerPosition.y, playerPosition.z - 5.0f, 0.0f, 1.0f, 0.0f);
                fppCam->RotateView(0, 0, 90, 0);
                fppCam->upDownAngle = 0;
                fppCam->horAngle = 270;
                mWorld->health = 20;
...
void StatePlay::Update(StateManager *sManager) {
    ...
    mWorld->AP = mWorld->FetchArmorPoints(mWorld->armorId[3], mWorld->armorId[2], mWorld->armorId[1],
                                          mWorld->armorId[0]);
    ...
    if (menuState == 0)//game state
    {
        ...
        if (furnaceTimes >= 0.5f) {
            if (mWorld->mFurnaces.size() > 0) {
                ...
                for (it = mWorld->mFurnaces.begin(); it != mWorld->mFurnaces.end(); ++it) {
                    if ((*it)->fuelTime > 0) {
                        (*it)->fuelTime -= 0.5f;
                        if (mWorld->GetBlock((*it)->furnaceX, (*it)->furnaceY, (*it)->furnaceZ) ==
                            FurnaceOff::getID()) {
        ...
        if (mWorld->mMonsterSpawners.size() > 0) {
            BoundingBox playerBox = BoundingBox(
                    Vector3(playerPosition.x - 0.15f, playerPosition.y - 1.60f, playerPosition.z - 0.15f),
                    Vector3(playerPosition.x + 0.15f, playerPosition.y + 0.2f, playerPosition.z + 0.15f));
                ...
                if (playerBox.intersect((*it)->actArea)) {
                    ...
                    if ((*it)->particleDelay1 <= 0) {
                        ...
                        for (int i = 0; i < 4; i++) {
                            ...
                            Particle *Smoke = new Particle(mWorld, "black smoke",
                                                           Vector3(particle_x, particle_y, particle_z));
                            Particle *Flame = new Particle(mWorld, "flame",
                                                           Vector3(particle_x, particle_y, particle_z));
                        ...
                        if ((*it)->MobToSpawn() == "zombie") {
                            ...
                            if (nearbyEntityAmount < 4) {
                                ...
                                for (int i = 0; i < count0; i++) {
                                    ...
                                    float spawn_y =
                                            mWorld->groundHeight(spawn_x + 0.5f, (*it)->GetY() + 1, spawn_z + 0.5f) +
                                            1.2f;

                                    mWorld->SpawnZombie((*it)->GetX() - 1 + rand() % 3, (*it)->GetY() + 1,
                                                        (*it)->GetZ() - 1 + rand() % 3);
                                }
                            }
                        }
        ...
        if (dt < 0.1f) {
            ...
            if (sleepTime <= 0.0f) {
                ...
                touchingCactus = false;
                if (mWorld->PlayerCollisionWithCactus(playerPosition) || mWorld->PlayerCollisionWithCactus(
                        Vector3(playerPosition.x, playerPosition.y - 1.5f, playerPosition.z))) {
                    touchingCactus = true;
                }

                //check if we will stand on ground
                Vector3 futureFootPosition = Vector3(footPosition.x, footPosition.y + playerVelocity.y * dt,
                                                     footPosition.z);
                if (mWorld->SolidAtPointForPlayer(futureFootPosition)) {
                    ...
                    if (mWorld->SolidAtPointForPlayer(futureFootPosition)) {
                        ...
                        if (mWorld->GetBlock(futureFootPosition.x, futureFootPosition.y, futureFootPosition.z) ==
                            CactusBlock::getID()) {
                            touchingCactus = true;
                        }
                    ...
                    {
                        if (!mWorld->PlayerInWater(
                                Vector3(futureFootPosition.x, futureFootPosition.y + 0.45f, futureFootPosition.z)) &&
                            !(mWorld->GetBlock(playerPosition.x, playerPosition.y - 1.3f, playerPosition.z) >=
                              Ladder1::getID() &&
                              mWorld->GetBlock(playerPosition.x, playerPosition.y - 1.3f, playerPosition.z) <=
                              Ladder4::getID())) {
                            if (playerVelocity.y < -6 && rand() % 10 >= 7) // destroy soil
                            {
                                if (mWorld->GetBlock(futureFootPosition.x, futureFootPosition.y - 0.25f,
                                                     futureFootPosition.z) == Soil::getID() ||
                                    mWorld->GetBlock(futureFootPosition.x, futureFootPosition.y - 0.25f,
                                                     futureFootPosition.z) == WateredSoil::getID()) {
                                    mWorld->GetBlock(futureFootPosition.x, futureFootPosition.y - 0.25f,
                                                     futureFootPosition.z) = DirtBlock::getID();
                                    if (mWorld->GetBlock(futureFootPosition.x, futureFootPosition.y + 0.25f,
                                                         futureFootPosition.z) != 0) {
                                        mWorld->DropThis(
                                                mWorld->BlockLoot(futureFootPosition.x, futureFootPosition.y + 0.25f,
                                                                  futureFootPosition.z), 1, true,
                                                Vector3(futureFootPosition.x, futureFootPosition.y + 0.25f,
                                                        futureFootPosition.z));
                                        mWorld->GetBlock(futureFootPosition.x, futureFootPosition.y + 0.25f,
                                                         futureFootPosition.z) = 0;
                                    }
                                    if (!mWorld->ChunksEqual(Vector3(futureFootPosition.x, futureFootPosition.y - 0.25f,
                                                                     futureFootPosition.z),
                                                             Vector3(futureFootPosition.x, futureFootPosition.y + 0.25f,
                                                                     futureFootPosition.z))) {
                                        mWorld->RebuildFullMeshChunk(mWorld->getChunkId(
                                                Vector3(futureFootPosition.x, futureFootPosition.y - 0.25f,
                                                        futureFootPosition.z)));
                                        mWorld->RebuildFullMeshChunk(mWorld->getChunkId(
                                                Vector3(futureFootPosition.x, futureFootPosition.y + 0.25f,
                            ...
                            if (playerVelocity.y < -12.8 && playerVelocity.y > -19) {
                                ...
                                if (mWorld->GetBlock(futureFootPosition.x, futureFootPosition.y - 0.25f,
                                                     futureFootPosition.z) == HayBale::getID()) {
                ...
                Vector3 futureHeadPosition = Vector3(headPosition.x, headPosition.y + playerVelocity.y * dt,
                                                     headPosition.z);
...
void StatePlay::Draw(StateManager *sManager) {
    mWorld->startSkyColor = mWorld->startClearSkyColor * (1.0 - mWorld->rainyColorAlpha) +
                            mWorld->startRainySkyColor * mWorld->rainyColorAlpha;
    mWorld->endSkyColor = mWorld->endClearSkyColor * (1.0 - mWorld->rainyColorAlpha) +
                          mWorld->endRainySkyColor * mWorld->rainyColorAlpha;
    mWorld->dawnSunsetSkyColor = mWorld->dawnSunsetClearSkyColor * (1.0 - mWorld->rainyColorAlpha) +
                                 mWorld->dawnSunsetRainySkyColor * mWorld->rainyColorAlpha;
    ...
    if (playerPosition.y <= 48) {
        Vector3 color = ((mWorld->startSkyColor * mWorld->brightFactor) * nullFactor +
                         (mWorld->dawnSunsetSkyColor * mWorld->dawnSunsetFactor * angleFactor)) *
                        (playerPosition.y / 48.0f) * (playerPosition.y / 48.0f);
    ...
    if (mWorld->mainOptions.detailedSky == 1) {
        if (playerPosition.y <= 48) {
            Vector3 color = ((mWorld->startSkyColor * mWorld->brightFactor) * nullFactor +
                             (mWorld->dawnSunsetSkyColor * mWorld->dawnSunsetFactor * angleFactor)) *
                            (playerPosition.y / 48.0f) * (playerPosition.y / 48.0f);
            sceGuFog(mWorld->mainOptions.horizontalViewDistance * 7,
                     mWorld->mainOptions.horizontalViewDistance * 14 + 168.0f,
                     GU_COLOR(color.x, color.y, color.z, 1.0));
        } else {
            Vector3 color = (mWorld->startSkyColor * mWorld->brightFactor) * nullFactor +
                            (mWorld->dawnSunsetSkyColor * mWorld->dawnSunsetFactor * angleFactor);
            sceGuFog(mWorld->mainOptions.horizontalViewDistance * 7,
        ...
        /// Skybox rendering
        {
            ...
            if (playerPosition.y <= 45) {
                skyBox->Render(mWorld->endSkyColor * mWorld->brightFactor * (playerPosition.y / 45.0f), playerPosition,
                               fppCam->horAngle / 180.0f * PI);
            } else {
                skyBox->Render(mWorld->endSkyColor * mWorld->brightFactor, playerPosition,
                               fppCam->horAngle / 180.0f * PI);
            }
            MatrixPop();
        }
        ...
        if (mWorld->rainyColorAlpha != 1) {
            MatrixColor(GU_COLOR(1.0f - mWorld->rainyColorAlpha, 1.0f - mWorld->rainyColorAlpha,
                                 1.0f - mWorld->rainyColorAlpha, 1.0f - mWorld->rainyColorAlpha));
        ...
        if (mWorld->rainyColorAlpha != 1.0f) {
            ...
            {
                if (headInWater == true) {
                    sceGuFog(0.0f, 15.0f, GU_COLOR(74.0f / 255.0f * mWorld->brightFactor * 0.6,
                                                   130.0f / 255.0f * mWorld->brightFactor * 0.6,
                                                   158.0f / 255.0f * mWorld->brightFactor * 0.6, 1.0f));
                } else {
                    if (playerPosition.y <= 48) {
                        Vector3 color = ((mWorld->startSkyColor * mWorld->brightFactor) * nullFactor +
                                         (mWorld->dawnSunsetSkyColor * mWorld->dawnSunsetFactor * angleFactor)) *
                                        (playerPosition.y / 48.0f) * (playerPosition.y / 48.0f);
                        sceGuFog(mWorld->mainOptions.horizontalViewDistance * 7 + 48.0f,
                                 mWorld->mainOptions.horizontalViewDistance * 14 + 122.0f,
                                 GU_COLOR(color.x, color.y, color.z, 1.0));
                    } else {
                        Vector3 color = (mWorld->startSkyColor * mWorld->brightFactor) * nullFactor +
                                        (mWorld->dawnSunsetSkyColor * mWorld->dawnSunsetFactor * angleFactor);
            ...
            if (playerPosition.y <= 48) {
                ...
                MatrixColor(GU_COLOR(mWorld->brightFactor, mWorld->brightFactor, mWorld->brightFactor,
                                     1 - mWorld->rainyColorAlpha));
            }
    ...
    if (mWorld->mainOptions.fogRendering == 1) /// FOG FOR WORLD
    {
        if (headInWater == true) {
            sceGuFog(0.0f, 15.0f,
                     GU_COLOR(74.0f / 255.0f * mWorld->brightFactor * 0.6, 130.0f / 255.0f * mWorld->brightFactor * 0.6,
                              158.0f / 255.0f * mWorld->brightFactor * 0.6, 1.0f));
        } else {
            ...
            if (playerPosition.y <= 48) {
                Vector3 color = ((Vector3(0.8f - (mWorld->rainyColorAlpha / 10.0f) * 3,
                                          0.8f - (mWorld->rainyColorAlpha / 10.0f) * 3,
                                          0.8f - (mWorld->rainyColorAlpha / 10.0f) * 3) * mWorld->brightFactor) *
                                 nullFactor + (mWorld->dawnSunsetSkyColor * mWorld->dawnSunsetFactor * angleFactor)) *
                                (playerPosition.y / 48.0f) * (playerPosition.y / 48.0f);
        ...
        for (int d = 0; d < mWorld->mDrops.size(); d++) {
            if (d < mWorld->mDrops.size() && mWorld->mDrops.empty() == false) {
                ...
                if (TestDrop->GetId() < 250) {
                    ...
                    mWorld->ItemHaveTerrainTexture(TestDrop->GetId()) ? TextureManager::Instance()->SetTextureModeulate(
                            texture) : TextureManager::Instance()->SetTextureModeulate(barItems);
                }
                ...
                if (TestTNT->toDestroy == false) {
                    if (menuState == 0)//game state
                    {
                        ...
                        if (time % 4 == 0 && rand() % 10 <= 6 && time > 40 && TestTNT->ignitedByPlayer) {
                            ...
                            Particle *Smoke = new Particle(mWorld, "smoke", Vector3(TestTNT->position.x +
                                                                                    (-0.1f + (rand() % 10) / 100.0f),
                                                                                    TestTNT->position.y + 0.60f,
                                                                                    TestTNT->position.z +
                                                                                    (-0.1f + (rand() % 10) / 100.0f)));
                ...
                if (TestTNT->toDestroy == true) {
                    for (float verAngle = 0.0f; verAngle <= PI; verAngle += PI / 4.0f) {
                        for (float horAngle = 0.0f; horAngle <= PI * 2; horAngle += PI / 2.0f) {
                            ...
                            Particle *Smoke = new Particle(mWorld, "smoke",
                                                           Vector3(TestTNT->position.x, TestTNT->position.y,
                                                                   TestTNT->position.z));
                            Smoke->SetVelocity(Vector3(mWorld->LengthDirX(horAngle, verAngle) * radius,
                                                       mWorld->LengthDirY(horAngle, verAngle) * radius,
                                                       mWorld->LengthDirZ(horAngle, verAngle) * radius));
                    ...
                    if (mParticles.size() < 64) {
                        Particle *Explosion = new Particle(mWorld, "explosion", Vector3(TestTNT->position.x - 1.2f,
                                                                                        TestTNT->position.y - 1.2f,
                                                                                        TestTNT->position.z));
                        Particle *Explosion2 = new Particle(mWorld, "explosion", Vector3(TestTNT->position.x + 1.2f,
                                                                                         TestTNT->position.y + 1.2f,
                                                                                         TestTNT->position.z));
                        Particle *Explosion3 = new Particle(mWorld, "explosion",
                                                            Vector3(TestTNT->position.x, TestTNT->position.y - 1.2f,
                                                                    TestTNT->position.z - 1.2f));
                        Particle *Explosion4 = new Particle(mWorld, "explosion",
                                                            Vector3(TestTNT->position.x, TestTNT->position.y + 1.2f,
                                                                    TestTNT->position.z + 1.2f));
                        Particle *Explosion5 = new Particle(mWorld, "explosion",
                                                            Vector3(TestTNT->position.x, TestTNT->position.y,
                                                                    TestTNT->position.z));
                ...
                if (TestZombie->toDestroy == true || (TestZombie->killed == true && TestZombie->deathTimer <= 0.0f)) {
                    if (TestZombie->killed == true) {
                        if (TestZombie->lastKickType != 2) // kicked by player or other death
                        {
                            int rfAmount = rand() % 3;
                            if (rfAmount != 0) {
                                mWorld->DropThis(RottenFlesh::getID(), rfAmount, true,
                                                 Vector3(TestZombie->position.x, TestZombie->position.y + 0.3f,
                                                         TestZombie->position.z));
                            }

                            // rare drop
                            if (rand() % 100 <= 2) {
                                mWorld->DropThis(IronBar::getID(), 1, true,
                                                 Vector3(TestZombie->position.x, TestZombie->position.y + 0.3f,
                                                         TestZombie->position.z));
                            }
                            if (rand() % 100 <= 3) {
                                mWorld->DropThis(Potato::getID(), 1, true,
                                                 Vector3(TestZombie->position.x, TestZombie->position.y + 0.3f,
                                                         TestZombie->position.z));
                            }
                            if (rand() % 100 <= 3) {
                                mWorld->DropThis(Carrot::getID(), 1, true,
                                                 Vector3(TestZombie->position.x, TestZombie->position.y + 0.3f,
                                                         TestZombie->position.z));
                            }
                            // end
                            ...
                            if (TestZombie->helmetId != -1 && rand() % 4 <= 2) {
                                mWorld->DropThis(TestZombie->helmetId, 30 + rand() % 20, false,
                                                 Vector3(TestZombie->position.x, TestZombie->position.y + 0.3f,
                                                         TestZombie->position.z));
                            }
                            if (TestZombie->chestplateId != -1 && rand() % 4 <= 2) {
                                mWorld->DropThis(TestZombie->chestplateId, 30 + rand() % 20, false,
                                                 Vector3(TestZombie->position.x, TestZombie->position.y + 0.3f,
                                                         TestZombie->position.z));
                            }
                            if (TestZombie->leggingsId != -1 && rand() % 4 <= 2) {
                                mWorld->DropThis(TestZombie->leggingsId, 30 + rand() % 20, false,
                                                 Vector3(TestZombie->position.x, TestZombie->position.y + 0.3f,
                                                         TestZombie->position.z));
                            }
                            if (TestZombie->bootsId != -1 && rand() % 4 <= 2) {
                                mWorld->DropThis(TestZombie->bootsId, 30 + rand() % 20, false,
                                                 Vector3(TestZombie->position.x, TestZombie->position.y + 0.3f,
                                                         TestZombie->position.z));
                            }
                        } else // killed by explosion
                        {
                            mWorld->DropThis(Bone::getID(), 1, true,
                                             Vector3(TestZombie->position.x, TestZombie->position.y + 0.3f,
                                                     TestZombie->position.z));
                            mWorld->DropThis(Bone::getID(), 1, true,
                                             Vector3(TestZombie->position.x, TestZombie->position.y + 0.3f,
                    ...
                    for (int k = 0; k <= 7; k++) {
                        Particle *Smoke = new Particle(mWorld, "smoke",
                                                       Vector3(TestZombie->position.x - 0.4 + (rand() % 9 / 10.0f),
                                                               TestZombie->position.y + 0.2f + (rand() % 7 / 5.0f),
                                                               TestZombie->position.z - 0.4 + (rand() % 9 / 10.0f)));
                        mParticles.push_back(Smoke);
                    }
            ...
            if (d < mWorld->mCows.size() && mWorld->mCows.empty() == false) {
                ...
                if (TestCow->toDestroy == true || (TestCow->killed == true && TestCow->deathTimer < 0.0f)) {
                    if (TestCow->killed == true) {
                        mWorld->DropThis(RawBeef::getID(), 1 + rand() % 2, true,
                                         Vector3(TestCow->position.x, TestCow->position.y + 0.3f, TestCow->position.z));
                        mWorld->DropThis(Leather::getID(), 1 + rand() % 2, true,
                                         Vector3(TestCow->position.x, TestCow->position.y + 0.3f, TestCow->position.z));
                    }

                    for (int k = 0; k <= 7; k++) {
                        Particle *Smoke = new Particle(mWorld, "smoke",
                                                       Vector3(TestCow->position.x - 0.5 + (rand() % 11 / 10.0f),
                                                               TestCow->position.y + 0.2 + (rand() % 4 / 5.0f),
                                                               TestCow->position.z - 0.5 + (rand() % 11 / 10.0f)));
                        k % 2 == 0 ? Smoke->SetVelocity(Vector3(-3 * rand() % 2, 0, -3 * rand() % 2))
                                   : Smoke->SetVelocity(Vector3(3 * rand() % 2, 0, 3 * rand() % 2));
                        mParticles.push_back(Smoke);
                    }
            ...
            if (d < mWorld->mSheeps.size() && mWorld->mSheeps.empty() == false) {
                ...
                if (TestSheep->toDestroy == true || (TestSheep->killed == true && TestSheep->deathTimer < 0.0f)) {
                    if (TestSheep->killed == true && TestSheep->sheared == false) {
                        mWorld->DropThis(BlackWoolBlock::getID() + TestSheep->GetFurColor(), 1, true,
                                         Vector3(TestSheep->position.x, TestSheep->position.y + 0.3f,
                                                 TestSheep->position.z));
                    }

                    for (int k = 0; k <= 7; k++) {
                        Particle *Smoke = new Particle(mWorld, "smoke",
                                                       Vector3(TestSheep->position.x - 0.5 + (rand() % 11 / 10.0f),
                                                               TestSheep->position.y + 0.2 + (rand() % 4 / 5.0f),
                                                               TestSheep->position.z - 0.5 + (rand() % 11 / 10.0f)));
                        k % 2 == 0 ? Smoke->SetVelocity(Vector3(-3 * rand() % 2, 0, -3 * rand() % 2))
                                   : Smoke->SetVelocity(Vector3(3 * rand() % 2, 0, 3 * rand() % 2));
                        mParticles.push_back(Smoke);
                    }
            ...
            if (d < mWorld->mCreepers.size() && mWorld->mCreepers.empty() == false) {
                ...
                if (TestCreeper->toDestroy == true || (TestCreeper->killed == true && TestCreeper->deathTimer < 0.0f)) {
                    if (TestCreeper->killed == true) {
                        ...
                        {
                            mWorld->DropThis(Gunpowder::getID(), 1, true,
                                             Vector3(TestCreeper->position.x, TestCreeper->position.y + 0.3f,
                                                     TestCreeper->position.z));
                            mWorld->DropThis(Gunpowder::getID(), rand() % 3, true,
                                             Vector3(TestCreeper->position.x, TestCreeper->position.y + 0.3f,
                                                     TestCreeper->position.z));
                        } else {
                            int drop_id = 1;
                            ...
                            mWorld->DropThis(drop_id, 1, false,
                                             Vector3(TestCreeper->position.x, TestCreeper->position.y + 0.3f,
                                                     TestCreeper->position.z));
                        }
                    }
                    ...
                    for (int k = 0; k <= 7; k++) {
                        Particle *Smoke = new Particle(mWorld, "smoke",
                                                       Vector3(TestCreeper->position.x - 0.5 + (rand() % 11 / 10.0f),
                                                               TestCreeper->position.y + 0.2 + (rand() % 4 / 5.0f),
                                                               TestCreeper->position.z - 0.5 + (rand() % 11 / 10.0f)));
                        k % 2 == 0 ? Smoke->SetVelocity(Vector3(-3 * rand() % 2, 0, -3 * rand() % 2))
                                   : Smoke->SetVelocity(Vector3(3 * rand() % 2, 0, 3 * rand() % 2));
                        mParticles.push_back(Smoke);
                    }
                ...
                if (TestCreeper->exploded == true) {
                    for (float verAngle = 0.0f; verAngle <= PI; verAngle += PI / 4.0f) {
                        for (float horAngle = 0.0f; horAngle <= PI * 2; horAngle += PI / 2.0f) {
                            ...
                            Particle *Smoke = new Particle(mWorld, "smoke",
                                                           Vector3(TestCreeper->position.x, TestCreeper->position.y,
                                                                   TestCreeper->position.z));
                            Smoke->SetVelocity(Vector3(mWorld->LengthDirX(horAngle, verAngle) * radius,
                                                       mWorld->LengthDirY(horAngle, verAngle) * radius,
                                                       mWorld->LengthDirZ(horAngle, verAngle) * radius));
                    ...
                    if (mParticles.size() < 64) {
                        Particle *Explosion = new Particle(mWorld, "explosion", Vector3(TestCreeper->position.x - 1.2f,
                                                                                        TestCreeper->position.y - 1.2f,
                                                                                        TestCreeper->position.z));
                        Particle *Explosion2 = new Particle(mWorld, "explosion", Vector3(TestCreeper->position.x + 1.2f,
                                                                                         TestCreeper->position.y + 1.2f,
                                                                                         TestCreeper->position.z));
                        Particle *Explosion3 = new Particle(mWorld, "explosion", Vector3(TestCreeper->position.x,
                                                                                         TestCreeper->position.y - 1.2f,
                                                                                         TestCreeper->position.z -
                                                                                         1.2f));
                        Particle *Explosion4 = new Particle(mWorld, "explosion", Vector3(TestCreeper->position.x,
                                                                                         TestCreeper->position.y + 1.2f,
                                                                                         TestCreeper->position.z +
                                                                                         1.2f));
                        Particle *Explosion5 = new Particle(mWorld, "explosion",
            ...
            if (i < mSnowBalls.size() && mSnowBalls.empty() == false) {
                ...
                if (UseSnowBall->CheckCollision(mWorld) == true) {
                    if (mParticles.size() <= 52) {
                        ...
                        {
                            Particle *SnowballPart = new Particle(mWorld, "item crack", Vector3(UseSnowBall->position.x,
    ...
    if (mWorld->mainOptions.guiDrawing == 1 && mWorld->health > 0) {
        ...
        if (sleepTime <= 0.0f) {
            if (mWorld->invId[27 + barPosition] == -1) // slot is empty so we need to draw steve's hand
            {
                ...
                //translate
                ScePspFVector3 move = {
                        0.53f + cubeBob + shift_x + (mWorld->mainOptions.fov - 70) / 200.0f + sinf(animDest) * -0.35,
                        -0.42f + shift_y + cubeBob2 + changeY, -0.5f + (mWorld->mainOptions.fov - 70) / 130.0f}; //446
            ...
            if (mWorld->invId[27 + barPosition] < 250 && mWorld->invId[27 + barPosition] != -1) {
                ...
                //translate
                ScePspFVector3 move = {
                        0.62f + cubeBob + shift_x + (mWorld->mainOptions.fov - 70) / 200.0f + sinf(animDest) * -0.35,
                        -0.35f + shift_y + cubeBob2 + changeY + sinf(animDest) * -0.1,
                        -0.7f + (mWorld->mainOptions.fov - 70) / 130.0f}; //446
                sceGumTranslate(&move);
                //rotate
            ...
            if (mWorld->invId[27 + barPosition] >= 250) {
                mWorld->ItemHaveTerrainTexture(mWorld->invId[27 + barPosition])
                ? TextureManager::Instance()->SetTextureModeulate(texture)
                ...
                //translate
                ScePspFVector3 move = {
                        0.523f + cubeBob + shift_x + (mWorld->mainOptions.fov - 70) / 250.0f + sinf(animDest) * -0.25,
                        -0.24f + cubeBob2 + shift_y + changeY, -0.6f + (mWorld->mainOptions.fov - 70) / 180.0f};//-0.17
    ...
    if ((invEn == false && craft3xEn == false && chestEn == false && furnaceEn == false && menuState == 0 &&
         mWorld->mainOptions.guiDrawing == 1) || (makeScreen == true && mWorld->mainOptions.guiDrawing == 1)) {
        hpAnim += dt * 5.9 * PI;
        if (hpAnim >= 10 * PI) {
            hpAnim = 0.0f;
        }
    ...
    if ((invEn == false && craft3xEn == false && chestEn == false && menuState == 0 &&
         mWorld->mainOptions.guiDrawing == 1 && furnaceEn == false) ||
    ...
    if ((invEn == false && craft3xEn == false && chestEn == false && furnaceEn == false && menuState == 0 &&
        ...
        for (int k = 0; k <= 8; k++) {
            if (mWorld->invId[27 + k] >= 250) {
                ...
                {
                    if (mWorld->invAm[27 + k] !=
                        mWorld->DurabilityPointsItem(mWorld->invId[27 + k])) // checking durability
                    {
                        unsigned int toolPointStd = roundf((float) (mWorld->invAm[27 + k]) /
                                                           (float) (mWorld->DurabilityPointsItem(
                                                                   mWorld->invId[27 + k])) * 13);
    ...
    if (invEn == true) {
        for (int i = 0; i <= 1; i++) {
            for (int j = 0; j <= 1; j++) {
                if (craftSlotId[i * 2 + j] >= 250 && mWorld->DurabilityPointsItem(craftSlotId[i * 2 + j]) != -1) {
                    if (craftSlotAm[i * 2 + j] !=
                        mWorld->DurabilityPointsItem(craftSlotId[i * 2 + j])) // checking durability
                    {
                        unsigned int toolPointStd = roundf((float) (craftSlotAm[i * 2 + j]) /
                                                           (float) (mWorld->DurabilityPointsItem(
                                                                   craftSlotId[i * 2 + j])) * 13);
        ...
        for (int i = 0; i <= 1; i++) {
            for (int j = 0; j <= 1; j++) {
                if (mWorld->armorId[i * 2 + j] >= 250 &&
                    mWorld->DurabilityPointsItem(mWorld->armorId[i * 2 + j]) != -1) {
                    if (mWorld->armorAm[i * 2 + j] !=
                        mWorld->DurabilityPointsItem(mWorld->armorId[i * 2 + j])) // checking durability
                    {
                        unsigned int toolPointStd = roundf((float) (mWorld->armorAm[i * 2 + j]) /
                                                           (float) (mWorld->DurabilityPointsItem(
                                                                   mWorld->armorId[i * 2 + j])) * 13);
        ...
        for (int i = 0; i <= 2; i++) {
            for (int j = 0; j <= 2; j++) {
                if (craftSlotId3[i * 3 + j] >= 250 && mWorld->DurabilityPointsItem(craftSlotId3[i * 3 + j]) != -1) {
                    if (craftSlotAm3[i * 3 + j] !=
                        mWorld->DurabilityPointsItem(craftSlotId3[i * 3 + j])) // checking durability
                    {
                        unsigned int toolPointStd = roundf((float) (craftSlotAm3[i * 3 + j]) /
                                                           (float) (mWorld->DurabilityPointsItem(
                                                                   craftSlotId3[i * 3 + j])) * 13);
    ...
    if (chestEn == true) {
        for (int i = 0; i <= 2; i++) {
            for (int j = 0; j <= 8; j++) {
                if (UseChest->chestSlotId[i * 9 + j] >= 250 &&
                    mWorld->DurabilityPointsItem(UseChest->chestSlotId[i * 9 + j]) != -1) {
                    if (UseChest->chestSlotAm[i * 9 + j] !=
                        mWorld->DurabilityPointsItem(UseChest->chestSlotId[i * 9 + j])) // checking durability
                    {
                        unsigned int toolPointStd = roundf((float) (UseChest->chestSlotAm[i * 9 + j]) /
                                                           (float) (mWorld->DurabilityPointsItem(
                                                                   UseChest->chestSlotId[i * 9 + j])) * 13);
    ...
    if (furnaceEn == true) {
        if (UseFurnace->furnaceSlotId[0] >= 250 && mWorld->DurabilityPointsItem(UseFurnace->furnaceSlotId[0]) !=
                                                   -1) // it is item and it have durability points
        {
            if (UseFurnace->furnaceSlotAm[0] != mWorld->DurabilityPointsItem(UseFurnace->furnaceSlotId[0]) != -1) {
                unsigned int toolPointStd = roundf((float) (UseFurnace->furnaceSlotAm[0]) /
                                                   (float) (mWorld->DurabilityPointsItem(
                                                           UseFurnace->furnaceSlotId[0])) * 13);
        ...
        if (UseFurnace->furnaceSlotId[1] >= 250 && mWorld->DurabilityPointsItem(UseFurnace->furnaceSlotId[1]) !=
                                                   -1) // it is item and it have durability points
        {
            if (UseFurnace->furnaceSlotAm[1] != mWorld->DurabilityPointsItem(UseFurnace->furnaceSlotId[1]) != -1) {
                unsigned int toolPointStd = roundf((float) (UseFurnace->furnaceSlotAm[1]) /
                                                   (float) (mWorld->DurabilityPointsItem(
                                                           UseFurnace->furnaceSlotId[1])) * 13);
    ...
    if (invEn == true || craft3xEn == true || chestEn == true || furnaceEn == true) {
        for (int i = 0; i <= 3; i++) {
            for (int j = 0; j <= 8; j++) {
                if (mWorld->invId[i * 9 + j] >= 250) {
                    ...
                    {
                        if (mWorld->invAm[i * 9 + j] !=
                            mWorld->DurabilityPointsItem(mWorld->invId[i * 9 + j])) // checking durability
                        {
                            unsigned int toolPointStd = roundf((float) (mWorld->invAm[i * 9 + j]) /
                                                               (float) (mWorld->DurabilityPointsItem(
                                                                       mWorld->invId[i * 9 + j])) * 13);
        ...
        if (mWorld->mId >= 250 && mWorld->DurabilityPointsItem(mWorld->mId) != -1) {
            if (mWorld->mAm != mWorld->DurabilityPointsItem(mWorld->mId)) {
                unsigned int toolPointStd = roundf(
                        (float) (mWorld->mAm) / (float) (mWorld->DurabilityPointsItem(mWorld->mId)) * 13);
                if (upEn == 1) {
                    if (invEn == 1) {
    ...
    if (invEn == false && craft3xEn == false && chestEn == false && furnaceEn == false && menuState == 0) {
        if (tickShowSlotName > 0.0f) {
            if (tickShowSlotName > 1.0f) {
                ...
                mRender->SetFontStyle(0.5f, GU_COLOR(1, 1, 1, tickShowSlotName),
                                      GU_COLOR(0.15f, 0.15f, 0.15f, tickShowSlotName), 0x00000200);
            }
            if (mWorld->invId[27 + barPosition] != -1) {
        ...
        if (tutorialTimer > 0.0f) {
            if (tutorialTimer > 9.0f && tutorialTimer <= 10.0f) {
                mRender->SetFontStyle(0.5f, GU_COLOR(1, 1, 1, 10.0f - tutorialTimer),
                                      GU_COLOR(1, 1, 1, 10.0f - tutorialTimer), 0x00000000);
            }
            if (tutorialTimer > 1.0f && tutorialTimer <= 9.0f) {
                mRender->SetFontStyle(0.5f, GU_COLOR(1, 1, 1, 1), GU_COLOR(1, 1, 1, 1), 0x00000000);
            }
            if (tutorialTimer <= 1.0f) {
                mRender->SetFontStyle(0.5f, GU_COLOR(1, 1, 1, tutorialTimer), GU_COLOR(1, 1, 1, tutorialTimer),
                                      0x00000000);
            }
        ...
        if (menuOptions) {
            ...
            if (language == ENGLISH) {
                if (mWorld->mainOptions.fov == 65) {
                    optionsMenuPos == 0 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1),
                                                                                     0, 0x00004000 | 0x00000200)
                                        : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1),
                                                                                     0, 0x00004000 | 0x00000200);
                ...
                if (mWorld->mainOptions.horizontalViewDistance == 1) {
                    optionsMenuPos == 1 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1),
                                                                                     0, 0x00004000 | 0x00000200)
                                        : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1),
                                                                                     0, 0x00004000 | 0x00000200);
                ...
                if (mWorld->mainOptions.verticalViewDistance == 1) {
                    optionsMenuPos == 8 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1),
                                                                                     0, 0x00004000 | 0x00000200)
                                        : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1),
                                                                                     0, 0x00004000 | 0x00000200);
                ...
                switch (mWorld->mainOptions.difficulty) {
                    case 0:
                        optionsMenuPos == 9 ? RenderManager::InstancePtr()->SetFontStyle(default_size,
                                            ...
                                            : RenderManager::InstancePtr()->SetFontStyle(default_size,
                                                                                         GU_COLOR(1, 1, 1, 1), 0,
                                                                                         0x00004000 | 0x00000200);
                ...
                optionsMenuPos == 2 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                                                                 0x00004000 | 0x00000200)
                                    : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                 0x00004000 | 0x00000200);
                mWorld->mainOptions.fogRendering == true ? mRender->DebugPrint(110, 109, "Fog Rendering: ON")
                                                         : mRender->DebugPrint(110, 109, "Fog Rendering: OFF");

                optionsMenuPos == 3 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                                                                 0x00004000 | 0x00000200)
                                    : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                 0x00004000 | 0x00000200);
                mWorld->mainOptions.detailedSky == true ? mRender->DebugPrint(110, 139, "Detailed Sky: ON")
                                                        : mRender->DebugPrint(110, 139, "Detailed Sky: OFF");

                optionsMenuPos == 4 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                                                                 0x00004000 | 0x00000200)
                                    : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                 0x00004000 | 0x00000200);
                mWorld->mainOptions.mipMapTexturing == true ? mRender->DebugPrint(110, 169, "MIP mapping: ON")
                                                            : mRender->DebugPrint(110, 169, "MIP mapping: OFF");

                optionsMenuPos == 5 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                                                                 0x00004000 | 0x00000200)
                                    : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                 0x00004000 | 0x00000200);
                mWorld->mainOptions.smoothLighting == true ? mRender->DebugPrint(110, 199, "Smooth Lighting: ON")
                                                           : mRender->DebugPrint(110, 199, "Smooth Lighting: OFF");

                optionsMenuPos == 6 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                                                                 0x00004000 | 0x00000200)
                                    : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                 0x00004000 | 0x00000200);
                mWorld->mainOptions.worldBlockAnimation == true ? mRender->DebugPrint(110, 229, "Animated Blocks: ON")
                                                                : mRender->DebugPrint(110, 229, "Animated Blocks: OFF");

                optionsMenuPos == 7 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                                                                 0x00004000 | 0x00000200)
                                    : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                 0x00004000 | 0x00000200);
                mWorld->mainOptions.autoJump == true ? mRender->DebugPrint(110, 259, "Auto-jump: ON")
                                                     : mRender->DebugPrint(110, 259, "Auto-jump: OFF");

                optionsMenuPos == 10 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                                                                  0x00004000 | 0x00000200)
                                     : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                  0x00004000 | 0x00000200);
                mRender->DebugPrint(370, 109, "Super Secret Settings");

                optionsMenuPos == 11 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                                                                  0x00004000 | 0x00000200)
                                     : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                  0x00004000 | 0x00000200);
                mWorld->mainOptions.guiDrawing == true ? mRender->DebugPrint(370, 139, "GUI Rendering: ON")
                                                       : mRender->DebugPrint(370, 139, "GUI Rendering: OFF");

                optionsMenuPos == 12 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                                                                  0x00004000 | 0x00000200)
                                     : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                  0x00004000 | 0x00000200);
                mWorld->mainOptions.sounds == true ? mRender->DebugPrint(370, 169, "Sounds: ON") : mRender->DebugPrint(
                        370, 169, "Sounds: OFF");

                optionsMenuPos == 13 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                                                                  0x00004000 | 0x00000200)
                                     : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                  0x00004000 | 0x00000200);
                mWorld->mainOptions.music == true ? mRender->DebugPrint(370, 199, "Music : ON") : mRender->DebugPrint(
                        370, 199, "Music : OFF");

                optionsMenuPos == 14 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                                                                  0x00004000 | 0x00000200)
                                     : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                  0x00004000 | 0x00000200);
                mRender->DebugPrint(370, 229, "Take Screenshot");

                optionsMenuPos == 15 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                                                                  0x00004000 | 0x00000200)
                                     : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                  0x00004000 | 0x00000200);
                devMode == true ? mRender->DebugPrint(370, 259, "Dev Mode: ON") : mRender->DebugPrint(370, 259,
                                                                                                      "Dev Mode: OFF");
            ...
            if (language == RUSSIAN) {
                ...
                if (mWorld->mainOptions.horizontalViewDistance == 1) {
                    optionsMenuPos == 1 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1),
                                        ...
                                        : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1),
                                                                                     0, 0x00004000 | 0x00000200);
                    mRender->DebugPrint(110, 79, "Gorizont. prorisovka : %i y",
                                        mWorld->mainOptions.horizontalViewDistance);
                } else {
                    optionsMenuPos == 1 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1),
                                                                                     0, 0x00004000 | 0x00000200)
                                        : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1),
                ...
                if (mWorld->mainOptions.verticalViewDistance == 1) {
                    ...
                    optionsMenuPos == 8 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1),
                                        ...
                                        : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1),
                                                                                     0, 0x00004000 | 0x00000200);
                    mRender->DebugPrint(370, 49, "Vertik.^ prorisovka : %i y",
                ...
                optionsMenuPos == 2 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                    ...
                                    : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                 0x00004000 | 0x00000200);
                mWorld->mainOptions.fogRendering == true ? mRender->DebugPrint(110, 109, "Tuman: Vkl")
                                                         : mRender->DebugPrint(110, 109, "Tuman: V@kl");

                optionsMenuPos == 3 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                                                                 0x00004000 | 0x00000200)
                                    : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                 0x00004000 | 0x00000200);
                mWorld->mainOptions.detailedSky == true ? mRender->DebugPrint(110, 139, "Detalizirovannoe nebo: Vkl")
                                                        : mRender->DebugPrint(110, 139, "Detalizirovannoe nebo: V@kl");

                optionsMenuPos == 4 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                                                                 0x00004000 | 0x00000200)
                                    : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                 0x00004000 | 0x00000200);
                mWorld->mainOptions.mipMapTexturing == true ? mRender->DebugPrint(110, 169, "MIP-teksturirovanie: Vkl")
                                                            : mRender->DebugPrint(110, 169,
                                                                                  "MIP-teksturirovanie: V@kl");

                optionsMenuPos == 5 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                                                                 0x00004000 | 0x00000200)
                                    : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                 0x00004000 | 0x00000200);
                mWorld->mainOptions.smoothLighting == true ? mRender->DebugPrint(110, 199, "M^gkoe osvexenie: Vkl")
                                                           : mRender->DebugPrint(110, 199, "M^gkoe osvexenie: V@kl");

                optionsMenuPos == 6 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                                                                 0x00004000 | 0x00000200)
                                    : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                 0x00004000 | 0x00000200);
                mWorld->mainOptions.worldBlockAnimation == true ? mRender->DebugPrint(110, 229, "Animaci^ blokov : Vkl")
                                                                : mRender->DebugPrint(110, 229,
                                                                                      "Animaci^ blokov: V@kl");
                ...
                optionsMenuPos == 7 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                    ...
                                    : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                 0x00004000 | 0x00000200);
                mWorld->mainOptions.autoJump == true ? mRender->DebugPrint(110, 259, "Avto-pr@jok: Vkl")
                                                     : mRender->DebugPrint(110, 259, "Avto-pr@jok: V@kl");
                ...
                optionsMenuPos == 11 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                     ...
                                     : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                  0x00004000 | 0x00000200);
                mWorld->mainOptions.guiDrawing == true ? mRender->DebugPrint(370, 139, "Interfe~s: Vkl")
                                                       : mRender->DebugPrint(370, 139, "Interfe~s: V@kl");

                optionsMenuPos == 12 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                                                                  0x00004000 | 0x00000200)
                                     : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                  0x00004000 | 0x00000200);
                mWorld->mainOptions.sounds == true ? mRender->DebugPrint(370, 169, "Zvuk: Vkl") : mRender->DebugPrint(
                        370, 169, "Zvuk: V@kl");
                ...
                optionsMenuPos == 13 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                     ...
                                     : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                  0x00004000 | 0x00000200);
                mWorld->mainOptions.music == true ? mRender->DebugPrint(370, 199, "Muz@ka: Vkl") : mRender->DebugPrint(
                        370, 199, "Muz@ka: V@kl");
                ...
                optionsMenuPos == 15 ? RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 0, 1), 0,
                                     ...
                                     : RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                                                  0x00004000 | 0x00000200);
                devMode == true ? mRender->DebugPrint(370, 259, "Rejim razrabotyika: Vkl") : mRender->DebugPrint(370,
                                                                                                                 259,
                                                                                                                 "Rejim razrabotyika: V@kl");
            ...
            if (language == ENGLISH) {
                ...
                selectPos == 0 ? DrawText(240, 59, GU_COLOR(1, 1, 0, 1), default_size, "Back to game") : DrawText(240,
                                                                                                                  59,
                                                                                                                  GU_COLOR(
                                                                                                                          1,
                                                                                                                          1,
                                                                                                                  ...
                                                                                                                  default_size,
                                                                                                                  "Back to game");
                selectPos == 1 ? DrawText(240, 89, GU_COLOR(1, 1, 0, 1), default_size, "Options...") : DrawText(240, 89,
                                                                                                                GU_COLOR(
                                                                                                                        1,
                                                                                                                        1,
                                                                                                                        1,
                                                                                                                ...
                                                                                                                default_size,
                                                                                                                "Options...");
                selectPos == 2 ? DrawText(240, 119, GU_COLOR(1, 1, 0, 1), default_size, "Statistics") : DrawText(240,
                                                                                                                 119,
                                                                                                                 GU_COLOR(
                                                                                                                         1,
                                                                                                                         1,
                                                                                                                 ...
                                                                                                                 default_size,
                                                                                                                 "Statistics");
                selectPos == 3 ? DrawText(240, 169, GU_COLOR(1, 1, 0, 1), default_size, "Save") : DrawText(240, 169,
                                                                                                           GU_COLOR(1,
                                                                                                                    1,
                                                                                                                    1,
                                                                                                                    1),
                                                                                                           default_size,
                                                                                                           "Save");
                selectPos == 4 ? DrawText(240, 199, GU_COLOR(1, 1, 0, 1), default_size, "Save and exit") : DrawText(240,
                                                                                                                    199,
                                                                                                                    GU_COLOR(
                                                                                                                            1,
                                                                                                                            1,
                                                                                                                    ...
                                                                                                                    default_size,
                                                                                                                    "Save and exit");
                selectPos == 5 ? DrawText(240, 229, GU_COLOR(1, 1, 0, 1), default_size, "Exit") : DrawText(240, 229,
                                                                                                           GU_COLOR(1,
                                                                                                                    1,
                                                                                                                    1,
                                                                                                                    1),
            ...
            if (language == RUSSIAN) {
                ...
                selectPos == 0 ? DrawText(240, 59, GU_COLOR(1, 1, 0, 1), default_size, "Vernut$s^ k igre") : DrawText(
                        240, 59, GU_COLOR(1, 1, 1, 1), default_size, "Vernut$s^ k igre");
                selectPos == 1 ? DrawText(240, 89, GU_COLOR(1, 1, 0, 1), default_size, "Nastro~ki...") : DrawText(240,
                                                                                                                  89,
                                                                                                                  GU_COLOR(
                                                                                                                          1,
                                                                                                                          1,
                                                                                                                  ...
                                                                                                                  default_size,
                                                                                                                  "Nastro~ki...");
                selectPos == 2 ? DrawText(240, 119, GU_COLOR(1, 1, 0, 1), default_size, "Statistika") : DrawText(240,
                                                                                                                 119,
                                                                                                                 GU_COLOR(
                                                                                                                         1,
                                                                                                                         1,
                                                                                                                 ...
                                                                                                                 default_size,
                                                                                                                 "Statistika");
                selectPos == 3 ? DrawText(240, 169, GU_COLOR(1, 1, 0, 1), default_size, "Sohranit$") : DrawText(240,
                                                                                                                169,
                                                                                                                GU_COLOR(
                                                                                                                        1,
                                                                                                                        1,
                                                                                                                ...
                                                                                                                default_size,
                                                                                                                "Sohranit$");
                selectPos == 4 ? DrawText(240, 199, GU_COLOR(1, 1, 0, 1), default_size, "Sohranit$ i v@~ti") : DrawText(
                        240, 199, GU_COLOR(1, 1, 1, 1), default_size, "Sohranit$ i v@~ti");
                selectPos == 5 ? DrawText(240, 229, GU_COLOR(1, 1, 0, 1), default_size, "V@~ti") : DrawText(240, 229,
                                                                                                            GU_COLOR(1,
                                                                                                                     1,
                                                                                                                     1,
                                                                                                                     1),
    ...
    if (menuState == 3) {
        if (language == ENGLISH) {
            if (statisticsPage == 0) {
                ...
                RenderManager::InstancePtr()->DebugPrint(200, 54, "Blocks Placed: %i",
                                                         mWorld->mainStatistics.blockPlaced);

                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(0.8, 0.8, 0.8, 1), 0,
                                                           0x00004000 | 0x00000000);
                RenderManager::InstancePtr()->DebugPrint(200, 74, "Blocks Destroyed: %i",
                                                         mWorld->mainStatistics.blockDestroyed);

                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                           0x00004000 | 0x00000000);
                RenderManager::InstancePtr()->DebugPrint(200, 94, "Age Of The World: %i d",
                                                         mWorld->mainStatistics.daysInGame);

                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(0.8, 0.8, 0.8, 1), 0,
                                                           0x00004000 | 0x00000000);
                RenderManager::InstancePtr()->DebugPrint(200, 114, "Minutes Played: %i m",
                                                         mWorld->mainStatistics.minutesPlayed);

                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                           0x00004000 | 0x00000000);
                RenderManager::InstancePtr()->DebugPrint(200, 134, "Items Crafted: %i",
                                                         mWorld->mainStatistics.itemsCrafted);

                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(0.8, 0.8, 0.8, 1), 0,
                                                           0x00004000 | 0x00000000);
                RenderManager::InstancePtr()->DebugPrint(200, 154, "Items Smelted: %i",
                                                         mWorld->mainStatistics.itemsSmelted);

                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                           0x00004000 | 0x00000000);
                RenderManager::InstancePtr()->DebugPrint(200, 174, "Soil Plowed: %i",
                                                         mWorld->mainStatistics.soilPlowed);

                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(0.8, 0.8, 0.8, 1), 0,
                                                           0x00004000 | 0x00000000);
                RenderManager::InstancePtr()->DebugPrint(200, 194, "Crops Grown: %i",
                                                         mWorld->mainStatistics.cropsGrowned);

                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                           0x00004000 | 0x00000000);
                RenderManager::InstancePtr()->DebugPrint(200, 214, "Trees Grown: %i",
                                                         mWorld->mainStatistics.treesGrowned);

                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(0.8, 0.8, 0.8, 1), 0,
                                                           0x00004000 | 0x00000000);
                RenderManager::InstancePtr()->DebugPrint(200, 234, "Damage Dealt: %i",
                                                         mWorld->mainStatistics.damageRecieved);
            } else {
                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                           0x00004000 | 0x00000000);
        ...
        if (language == RUSSIAN) {
            if (statisticsPage == 0) {
                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                           0x00004000 | 0x00000000);
                RenderManager::InstancePtr()->DebugPrint(200, 54, "Blokov v@stavleno: %i",
                                                         mWorld->mainStatistics.blockPlaced);

                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(0.8, 0.8, 0.8, 1), 0,
                                                           0x00004000 | 0x00000000);
                RenderManager::InstancePtr()->DebugPrint(200, 74, "Blokov razruweno: %i",
                                                         mWorld->mainStatistics.blockDestroyed);

                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                           0x00004000 | 0x00000000);
                RenderManager::InstancePtr()->DebugPrint(200, 94, "Vozrast mira: %i d",
                                                         mWorld->mainStatistics.daysInGame);

                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(0.8, 0.8, 0.8, 1), 0,
                                                           0x00004000 | 0x00000000);
                RenderManager::InstancePtr()->DebugPrint(200, 114, "Minut s@grano: %i m",
                                                         mWorld->mainStatistics.minutesPlayed);

                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                           0x00004000 | 0x00000000);
                RenderManager::InstancePtr()->DebugPrint(200, 134, "Vexe~ sozdano: %i",
                                                         mWorld->mainStatistics.itemsCrafted);

                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(0.8, 0.8, 0.8, 1), 0,
                                                           0x00004000 | 0x00000000);
                RenderManager::InstancePtr()->DebugPrint(200, 154, "Predmetov pereplavleno: %i",
                                                         mWorld->mainStatistics.itemsSmelted);

                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                           0x00004000 | 0x00000000);
                RenderManager::InstancePtr()->DebugPrint(200, 174, "Zemli vskopano: %i",
                                                         mWorld->mainStatistics.soilPlowed);

                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(0.8, 0.8, 0.8, 1), 0,
                                                           0x00004000 | 0x00000000);
                RenderManager::InstancePtr()->DebugPrint(200, 194, "Kul$tur v@raxeno: %i",
                                                         mWorld->mainStatistics.cropsGrowned);

                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                           0x00004000 | 0x00000000);
                RenderManager::InstancePtr()->DebugPrint(200, 214, "Derev$ev v@raxeno: %i",
                                                         mWorld->mainStatistics.treesGrowned);

                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(0.8, 0.8, 0.8, 1), 0,
                                                           0x00004000 | 0x00000000);
                RenderManager::InstancePtr()->DebugPrint(200, 234, "Urona poluyeno: %i",
                                                         mWorld->mainStatistics.damageRecieved);
            } else {
                RenderManager::InstancePtr()->SetFontStyle(default_size, GU_COLOR(1, 1, 1, 1), 0,
                                                           0x00004000 | 0x00000000);
                RenderManager::InstancePtr()->DebugPrint(200, 54, "Padeni~ s v@sot@: %i",
                                                         mWorld->mainStatistics.badlyFalls);
...
bool StatePlay::TryToMove(Vector3 moveVector, float dt) {
    ...
    if (!mWorld->SolidAtPointForPlayer(movePosition) && !mWorld->SolidAtPointForPlayer(lowerBodyPoint) &&
        !mWorld->SolidAtPointForPlayer(midBodyPoint)) {
    ...
    if ((mWorld->blockTypes[lowerBlock].blockModel == 1 ||
         (mWorld->blockTypes[lowerBlock].blockModel >= 6 && mWorld->blockTypes[lowerBlock].blockModel <= 9)) &&
...
void StatePlay::DrawAmount(int x, int y, int amount) {
    ...
    if (dozens != 0) {
        RenderManager::InstancePtr()->SetFontStyle(default_big_size, GU_COLOR(0.25f, 0.25f, 0.25f, 1.0f), 0,
                                                   0x00000400 | 0x00004000);
        RenderManager::InstancePtr()->DebugPrint(x + 2, y + 2, "%i", dozens);
        RenderManager::InstancePtr()->SetFontStyle(default_big_size, GU_COLOR(1.0f, 1.0f, 1.0f, 1.0f), 0,
                                                   0x00000400 | 0x00004000);
