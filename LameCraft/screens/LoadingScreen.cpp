    ...
    while (1) {
        ...
        if (RenderManager::InstancePtr()->GetFontLanguage() == ENGLISH) {
            ...
            switch (tip) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    RenderManager::InstancePtr()->DebugPrint(240, 240,
                                                             "Tip : press up button + R trigger to drop item");
                    break;
                case 3:
        ...
        if (RenderManager::InstancePtr()->GetFontLanguage() == RUSSIAN) {
            ...
            switch (tip) {
                case 0:
                    RenderManager::InstancePtr()->DebugPrint(240, 240,
                                                             "Najmite prav@~ + lev@~ triger, ytob@ otkr@t$ inventar$");
                    break;
                case 1:
                    RenderManager::InstancePtr()->DebugPrint(240, 240,
                                                             "Najmite prav@~ + lev@~ triger, ytob@ otkr@t$ inventar$");
                ...
                case 2:
                    ...
                    RenderManager::InstancePtr()->DebugPrint(240, 255,
                                                             "i najmite prav@~ triger, ytob@ otkr@t$ menq verstaka");
                    break;
                case 3:
                    RenderManager::InstancePtr()->DebugPrint(240, 240, "Navedite pricel na verstak");
                    RenderManager::InstancePtr()->DebugPrint(240, 255,
