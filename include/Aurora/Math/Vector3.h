...
namespace Aurora {
    namespace Math {
        ...
        inline Vector3 Vector3::Normal(
                Vector3 vTriangle[]) {                                                        // Get 2 vectors from the polygon (2 sides), Remember the order!
            Vector3 vVector1 = vTriangle[2] - vTriangle[0];
            Vector3 vVector2 = vTriangle[1] - vTriangle[0];

            Vector3 vNormal = Vector3::cross3(vVector1,
                                              vVector2);        // Take the cross product of our 2 vectors to get a perpendicular vector
