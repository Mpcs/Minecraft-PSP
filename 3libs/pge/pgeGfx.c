...
unsigned int pgeGfxColorSub(unsigned int color1, unsigned int color2) {
    unsigned int color = GU_RGBA(R(color1) - R(color2), G(color1) - G(color2), B(color1) - B(color2),
                                 A(color1) - A(color2));
...
unsigned int pgeGfxColorMulScalar(unsigned int color, float scalar) {
    unsigned int retcolor = GU_RGBA((int) (R(color) * scalar), (int) (G(color) * scalar), (int) (B(color) * scalar),
                                    (int) (A(color) * scalar));
...
unsigned int pgeGfxColorDivScalar(unsigned int color, float scalar) {
    if (scalar != 0.0f) {
        ...
        unsigned int retcolor = GU_RGBA((int) (R(color) * mulscalar), (int) (G(color) * mulscalar),
                                        (int) (B(color) * mulscalar), (int) (A(color) * mulscalar));
...
unsigned int pgeGfxColorClamp(unsigned int color) {
    unsigned int color2 = GU_RGBA(pgeGfxColorClamp(R(color)), pgeGfxColorClamp(G(color)), pgeGfxColorClamp(B(color)),
                                  pgeGfxColorClamp(A(color)));
